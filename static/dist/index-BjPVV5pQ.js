import { bb as v, bh as i, be as _, bp as W, bg as e, bx as g, ba as x, b9 as V, bd as p, bc as U, bo as E, bf as N } from "./vendor-BCH5z7Ar.js";
const j = 168, X = 169, C = 170, I = 1, D = 2, w = 3, L = 171, F = 172, Y = 4, z = 173, K = 5, A = 174, T = 175, Z = 176, s = 177, G = 6, q = 7, B = 8, H = 9, c = 0, R = [
  ...
  8287,
  12288
], M = 58, J = 40, m = 95, OO = 91, l = 45, $O = 46, f = 35, eO = 37, b = 123, QO = 125, d = 47, S = 42, r = 10, k = 61, tO = 43, aO = 38;
function o(O) {
...
const nO = new i((O, $) => {
  ...
  if (O.next == QO) {
    for (O.advance(); o(O.next) || O.next == l || O.next == m || y(O.next); )
      O.advance();
    O.next == f && O.peek(1) == b ? O.acceptToken(D, 2) : O.acceptToken(I);
  }
}), dO = new i((O) => {
...
const cO = new u(null, 0), sO = new W({
  start: cO,
  shift(O, $, Q, t) {
    return $ == j ? new u(O, Q.pos - t.pos) : $ == X ? O.parent : O;
  },
  hash(O) {
    return O.hash;
  }
...
}), YO = /* @__PURE__ */ g((O) => O.name == "VariableName" || O.name == "SassVariableName");
function TO(O) {
  return new V(O != null && O.indented ? wO : P, P.data.of({ autocomplete: YO }));
}
export {
  TO as sass,
