import { s as I, d as _, p as R } from "./styles-b4e223ce-DW1neqPp.js";
import { l as d, g as c, d as w, u as B, J as G, k as D, K as E, L as C, M as A } from "./vendor-CW5mw3QE.js";
import { G as z } from "./graph-U_MazhNF.js";
import { r as P } from "./index-5325376f-98fjXeHJ.js";
...
`), e.style === void 0 && (o.style = o.style || "stroke: #333; stroke-width: 1.5px;fill:none"), o.labelStyle = o.labelStyle.replace("color:", "fill:"))), t.setEdge(e.id1, e.id2, o, a);
  ...
  d.info(f), q(n, l, t, a), $(p, l, t, a), H(f, l), F(h, l, f.length + 1, p);
  let u;
  i === "sandbox" && (u = w("#i" + t));
  ...
  if (await P(
    ...
    const T = i === "sandbox" ? u.nodes()[0].contentDocument : document, M = T.querySelectorAll('[id="' + t + '"] .edgeLabel .label');
    for (const g of M) {
