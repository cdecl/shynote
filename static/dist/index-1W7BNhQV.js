import { bb as s, bh as R, bl as Y, be as x, bp as w, bg as O, ba as d, bq as X, b9 as k, bi as h, bj as f, bc as u, bd as y, bf as l, bm as g, bn as b, bo as j, bk as U, br as G, bs as Z } from "./vendor-T05Wpcog.js";
...
], S = /* @__PURE__ */ new G(), T = /* @__PURE__ */ new Set([
  "SourceFile",
  "Block",
  "FunctionDecl",
  "MethodDecl",
...
const p = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, m = [
  ...
  parser: /* @__PURE__ */ PO.configure({
    props: [
      ...
      /* @__PURE__ */ y.add({
        "Block SwitchBlock SelectBlock LiteralValue InterfaceType StructType SpecList": j,
        BlockComment(Q) {
