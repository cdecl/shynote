import { C as vt, D as Ct, s as Ot, a as Pt, b as Gt, c as It, g as C, l as B, d as St, B as At, H as Nt, E as Ht, k as D, I as Bt } from "./vendor-BoF2JRZw.js";
var mt = (function() {
  ...
  x.forEach((_) => {
    ...
    if (w === "TB" ? j[b.id] = { x: g, y: f } : j[b.id] = { x: f, y: k }, l) {
      if (b.type !== P.CHERRY_PICK && (b.customId && b.type === P.MERGE || b.type !== P.MERGE) && h.showCommitLabel) {
        ...
        if (S.attr("x", f - o.width / 2 - 2).attr("y", k + 13.5).attr("width", o.width + 4).attr("height", o.height + 4), w === "TB" && (S.attr("x", g - (o.width + 16 + 5)).attr("y", k - 12), I.attr("x", g - (o.width + 16)).attr("y", k + o.height - 12)), w !== "TB" && I.attr("x", f - o.width / 2), h.rotateCommitLabel)
          if (w === "TB")
