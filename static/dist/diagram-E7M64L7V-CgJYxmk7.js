import { aD as w, b6 as te, b7 as ae, ba as he, aK as ue, aJ as Z, ci as P, d as j, aH as pe, aG as fe, aX as ge, aY as me, aF as ye, aE as Se, b8 as ve, cj as xe, b2 as be } from "./vendor-Dsy1-eqI.js";
import { s as we } from "./chunk-KX2RTZJC-DbMRxAwL.js";
import { p as Ce } from "./chunk-4BX2VUAB-DKQQMPTJ.js";
import { p as Te } from "./treemap-KZPCXAKY-COtvFBW2.js";
import { b as O } from "./defaultLocale-D7EN2tov.js";
import { o as U } from "./ordinal-B6-f3MAq.js";
function Le(t) {
...
function Ze() {
  ...
  return u.round = function(r) {
    ...
    return arguments.length ? (d = typeof r == "function" ? r : X(+r), u) : d;
  }, u.paddingRight = function(r) {
    return arguments.length ? (h = typeof r == "function" ? r : X(+r), u) : h;
  }, u.paddingBottom = function(r) {
    return arguments.length ? (g = typeof r == "function" ? r : X(+r), u) : g;
  }, u.paddingLeft = function(r) {
    return arguments.length ? (c = typeof r == "function" ? r : X(+r), u) : c;
  }, u;
}
var E, ne = (E = class {
  constructor() {
...
var Qe = /* @__PURE__ */ w((t, a) => {
  ...
  for (const s of t.TreemapRows ?? []) {
    ...
    if (!d)
      continue;
    const h = s.indent ? parseInt(s.indent) : 0, g = et(d), c = d.classSelector ? a.getStylesForClass(d.classSelector) : [], u = c.length > 0 ? c : void 0, b = {
      level: h,
      name: g,
      type: d.$type,
      value: d.value,
  ...
  const V = b.append("g").attr("transform", `translate(0, ${u})`).attr("class", "treemapContainer"), R = Q(g).sum((e) => e.value ?? 0).sort((e, i) => (i.value ?? 0) - (e.value ?? 0)), ee = Ze().size([r, x]).paddingTop(
  ...
  Y.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e) => e.parent ? m(e.parent.data.name) : m(e.data.name)).attr("style", (e) => P({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", 0.3).attr("stroke", (e) => e.parent ? m(e.parent.data.name) : m(e.data.name)).attr("stroke-width", 3), Y.append("clipPath").attr("id", (e, i) => `clip-${a}-${i}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 4)).attr("height", (e) => Math.max(0, e.y1 - e.y0 - 4)), Y.append("text").attr("class", "treemapLabel").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", (e) => (e.y1 - e.y0) / 2).attr("style", (e) => {
    ...
    const i = j(this), f = e.x1 - e.x0, C = e.y1 - e.y0, L = i.node(), $ = 4, D = f - 2 * $, A = C - 2 * $;
    if (D < 10 || A < 10) {
