import { s as G, a as R, S as N } from "./chunk-NQ4KR5QH-DsvVa0bq.js";
import { aD as f, aI as t, d as H, aJ as S, aK as P, aQ as z, D as U, H as _, bh as C, aW as F } from "./vendor-CW5mw3QE.js";
import { G as D } from "./graph-B4hdnUXB.js";
import { l as J } from "./layout-ADgqw_BR.js";
var O = /* @__PURE__ */ f((e) => e.append("circle").attr("class", "start-state").attr("r", t().state.sizeUnit).attr("cx", t().state.padding + t().state.sizeUnit).attr("cy", t().state.padding + t().state.sizeUnit), "drawStartState"), X = /* @__PURE__ */ f((e) => e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", t().state.textHeight).attr("class", "divider").attr("x2", t().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), I = /* @__PURE__ */ f((e, i) => {
  ...
  i.type === "start" && O(n), i.type === "end" && q(n), (i.type === "fork" || i.type === "join") && K(n, i), i.type === "note" && Z(i.note.text, n), i.type === "divider" && X(n), i.type === "default" && i.descriptions.length === 0 && I(n, i), i.type === "default" && i.descriptions.length > 0 && Y(n, i);
  const l = n.node().getBBox();
  return c.width = l.width + 2 * t().state.padding, c.height = l.height + 2 * t().state.padding, c;
}, "drawState"), W = 0, j = /* @__PURE__ */ f(function(e, i, d) {
  ...
  const n = i.points, l = U().x(function(s) {
    ...
    return s.y;
  }).curve(_), x = e.append("path").attr("d", l(n)).attr("id", "edge" + W).attr("class", "transition");
  let a = "";
  ...
  a.edges().forEach(function(r) {
    r !== void 0 && a.edge(r) !== void 0 && (S.debug("Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(a.edge(r))), j(i, a.edge(r), a.edge(r).relation));
  }), E = B.getBBox();
  const k = {
    id: d || "root",
    label: d || "root",
