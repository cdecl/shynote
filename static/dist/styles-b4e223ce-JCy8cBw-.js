import { o as ut, p as rt, g as F, s as at, a as lt, b as ct, c as ot, k as v, u as We, l as ht, r as At, i as pt, I as Re, d as z } from "./vendor-Dsy1-eqI.js";
var Ve = (function() {
  var e = function(x, u, a, h) {
    ...
    parse: function(u) {
      var a = this, h = [0], n = [], f = [null], t = [], U = this.table, s = "", le = 0, Ke = 0, tt = 2, Ye = 1, st = t.slice.call(arguments, 1), b = Object.create(this.lexer), O = { yy: {} };
      for (var ve in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, ve) && (O.yy[ve] = this.yy[ve]);
      b.setInput(u, O.yy), O.yy.lexer = b, O.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var xe = b.yylloc;
      t.push(xe);
      ...
      for (var T, R, y, Ie, P = {}, ce, N, Qe, oe; ; ) {
        if (R = h[h.length - 1], this.defaultActions[R] ? y = this.defaultActions[R] : ((T === null || typeof T > "u") && (T = nt()), y = U[R] && U[R][T]), typeof y > "u" || !y.length || !y[0]) {
          ...
          b.showPosition ? Oe = "Parse error on line " + (le + 1) + `:
` + b.showPosition() + `
Expecting ` + oe.join(", ") + ", got '" + (this.terminals_[T] || T) + "'" : Oe = "Parse error on line " + (le + 1) + ": Unexpected " + (T == Ye ? "end of input" : "'" + (this.terminals_[T] || T) + "'"), this.parseError(Oe, {
            text: b.match,
...
const V = (e) => v.sanitizeText(e, F()), w = function(e) {
  ...
  return i ? I[i].classes[e].tooltip : p[e].tooltip;
}, _t = function(e, i, r) {
  const l = F();
...
const It = () => $e, Ot = (e) => {
  ...
  if (I[e] !== void 0)
    for (const r of i) {
      const { className: l } = w(r);
      p[l].parent = e, I[e].classes[l] = p[l];
    }
}, Mt = function(e, i) {
  const r = p[e];
  if (!(!i || !r))
