import { aD as l, aJ as m, d as q } from "./vendor-Dsy1-eqI.js";
import { c as P } from "./cytoscape.esm-Cvf3sx9F.js";
import { c as O } from "./cytoscape-cose-bilkent-Cvyu6GNW.js";
P.use(O);
function D(t, o) {
  t.forEach((e) => {
    const n = {
...
async function v(t, o) {
  m.debug("Starting cose-bilkent layout algorithm");
  try {
    B(t);
    const e = await $(t), n = X(e), i = Y(e);
    return m.debug(`Layout completed: ${n.length} nodes, ${i.length} edges`), {
      nodes: n,
      edges: i
    };
  } catch (e) {
    throw m.error("Error in cose-bilkent layout algorithm:", e), e;
  }
}
