...
import { aw as an, ax as V, ay as D, az as rn, aA as y, V as on, aB as K, aC as _, aD as un, aE as t, aF as sn, aG as tn, aH as fn } from "./vendor-DsVEk2JX.js";
function cn(l) {
      ...
      if (P > y) {
        ...
        if (O < an)
          if (q = xn(j, J, X, Y, Q, U, M, N)) {
            var Z = j - q[0], $ = J - q[1], k = Q - q[0], b = U - q[1], nn = 1 / D(fn((Z * k + $ * b) / (K(Z * Z + $ * $) * K(k * k + b * b))) / 2), en = K(q[0] * q[0] + q[1] * q[1]);
