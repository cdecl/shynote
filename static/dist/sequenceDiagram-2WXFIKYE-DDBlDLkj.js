import { aD as _, aT as je, aI as et, d as kt, aJ as Q, aO as ve, aK as ts, aL as es, aQ as S, aH as Pe, aE as ss, aX as rs, aG as as, aF as is, aY as ns, aZ as os, a_ as cs, b2 as ls, aN as vt, aW as H, be as U, bf as Nt, bb as Ce, bg as hs, bh as ds, bi as Me, b7 as Gt } from "./vendor-CW5mw3QE.js";
import { a as Ts, b as Qt, g as lt, d as Es, e as $t, f as jt } from "./chunk-JSJVCQXG-dKYYhCTc.js";
import { I as ps } from "./chunk-QZHKN3VN-DoYwWpoZ.js";
var Xt = (function() {
  var e = /* @__PURE__ */ _(function(Tt, L, m, N) {
    for (m = m || {}, N = Tt.length; N--; m[Tt[N]] = L) ;
    return m;
  }, "o"), t = [1, 2], a = [1, 3], s = [1, 4], i = [2, 4], n = [1, 9], o = [1, 11], h = [1, 12], l = [1, 14], r = [1, 15], E = [1, 17], p = [1, 18], f = [1, 19], u = [1, 25], y = [1, 26], R = [1, 27], b = [1, 28], w = [1, 29], A = [1, 30], D = [1, 31], k = [1, 32], M = [1, 33], W = [1, 34], K = [1, 35], q = [1, 36], G = [1, 37], X = [1, 38], z = [1, 39], v = [1, 40], $ = [1, 42], J = [1, 43], j = [1, 44], st = [1, 45], rt = [1, 46], O = [1, 47], I = [1, 4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 49, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], nt = [1, 74], ot = [1, 80], C = [1, 81], te = [1, 82], ee = [1, 83], se = [1, 84], re = [1, 85], ae = [1, 86], ie = [1, 87], ne = [1, 88], oe = [1, 89], ce = [1, 90], le = [1, 91], he = [1, 92], de = [1, 93], Te = [1, 94], Ee = [1, 95], pe = [1, 96], ue = [1, 97], _e = [1, 98], fe = [1, 99], ge = [1, 100], xe = [1, 101], Ie = [1, 102], Re = [1, 103], Oe = [1, 104], ye = [1, 105], Le = [2, 78], Lt = [4, 5, 17, 51, 53, 54], mt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 51, 53, 54, 56, 61, 62, 63, 64, 73], be = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 50, 51, 53, 54, 56, 61, 62, 63, 64, 73], Wt = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 49, 51, 53, 54, 56, 61, 62, 63, 64, 73], Se = [4, 5, 10, 14, 15, 17, 19, 22, 24, 30, 31, 32, 34, 36, 37, 38, 39, 40, 42, 44, 45, 47, 48, 51, 53, 54, 56, 61, 62, 63, 64, 73], Kt = [5, 52], B = [70, 71, 72, 73], at = [1, 151], Ft = {
...
Expecting ` + Dt.join(", ") + ", got '" + (this.terminals_[Z] || Z) + "'" : Ut = "Parse error on line " + (wt + 1) + ": Unexpected " + (Z == me ? "end of input" : "'" + (this.terminals_[Z] || Z) + "'"), this.parseError(Ut, {
        ...
        switch (it[0]) {
          case 1:
            N.push(Z), V.push(F.yytext), c.push(F.yylloc), N.push(it[1]), Z = null, Ne = F.yyleng, T = F.yytext, wt = F.yylineno, qt = F.yylloc;
            break;
          case 2:
...
`, "getStyles"), Rs = Is, ft = 36, Et = "actor-top", pt = "actor-bottom", Bt = "actor-box", gt = "actor-man", St = /* @__PURE__ */ _(function(e, t) {
  ...
  if (f.attr("class", "actorPopupMenuPanel" + E), f.attr("x", h.x), f.attr("y", h.height), f.attr("fill", h.fill), f.attr("stroke", h.stroke), f.attr("width", p), f.attr("height", h.height), f.attr("rx", h.rx), f.attr("ry", h.ry), n != null) {
    ...
    for (let b in n) {
      ...
      y.attr("xlink:href", R), y.attr("target", "_blank"), qs(s)(
        b,
        y,
        h.x + 10,
        h.height + u,
...
}, "getTextObj"), Hs = /* @__PURE__ */ _(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
...
async function Ke(e, t) {
  ...
  const { startx: a, stopx: s, message: i } = t, n = S.splitBreaks(i).length, o = U(i), h = o ? await Nt(i, et()) : H.calculateTextDimensions(i, xt(d));
  if (!o) {
    const p = h.height / n;
...
var Qs = /* @__PURE__ */ _(async function(e, t, a, s, i) {
  const { startx: n, stopx: o, starty: h, message: l, type: r, sequenceIndex: E, sequenceVisible: p } = t, f = H.calculateTextDimensions(l, xt(d)), u = Qt();
...
}, "drawActorsPopup"), He = /* @__PURE__ */ _(function(e) {
...
function ct(e, t, a, s, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    ...
    t.message = H.wrapLabel(`[${t.message}]`, o - 2 * d.wrapPadding, h), t.width = o, t.wrap = !0;
    const l = H.calculateTextDimensions(t.message, h), r = S.getMax(l.height, d.labelBoxHeight);
      ...
      default:
        try {
          ...
          qe(
            ...
            p,
            f
          ), q.push({ messageModel: ot, lineStartY: C, msg: O }), x.models.addMessage(ot);
        } catch (C) {
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      if (i.placement === a.db.PLACEMENT.LEFTOF && !n.prevActor || i.placement === a.db.PLACEMENT.RIGHTOF && !n.nextActor)
        continue;
      const o = i.placement !== void 0, h = !o, l = o ? Rt(d) : xt(d), r = i.wrap ? H.wrapLabel(i.message, d.width - 2 * d.wrapPadding, l) : i.message, p = (U(r) ? await Nt(i.message, et()) : H.calculateTextDimensions(r, l)).width + 2 * d.wrapPadding;
...
async function Ue(e, t, a) {
  ...
  for (const n of e.keys()) {
    const o = e.get(n);
    o.wrap && (o.description = H.wrapLabel(
      o.description,
      d.width - 2 * d.wrapPadding,
      Jt(d)
    ));
    const h = U(o.description) ? await Nt(o.description, et()) : H.calculateTextDimensions(o.description, Jt(d));
  ...
  return a.forEach((n) => {
    ...
    h += l, h -= 2 * d.boxTextMargin, n.wrap && (n.name = H.wrapLabel(n.name, h - 2 * d.wrapPadding, o));
...
var er = /* @__PURE__ */ _(async function(e, t, a) {
  ...
  let l = U(e.message) ? await Nt(e.message, et()) : H.calculateTextDimensions(
    h ? H.wrapLabel(e.message, d.width, Rt(d)) : e.message,
    Rt(d)
  );
  const r = {
  ...
  return e.placement === a.db.PLACEMENT.RIGHTOF ? (r.width = h ? S.getMax(d.width, l.width) : S.getMax(
    ...
    s.width / 2 + i.width / 2,
    l.width + 2 * d.noteMargin
  ), r.startx = n - r.width + (s.width - d.actorMargin) / 2) : e.to === e.from ? (l = H.calculateTextDimensions(
    h ? H.wrapLabel(e.message, S.getMax(d.width, s.width), Rt(d)) : e.message,
    Rt(d)
  ), r.width = h ? S.getMax(d.width, s.width) : S.getMax(s.width, d.width, l.width + 2 * d.noteMargin), r.startx = n + (s.width - r.width) / 2) : (r.width = Math.abs(n + s.width / 2 - (o + i.width / 2)) + d.actorMargin, r.startx = n < o ? n + s.width / 2 - d.actorMargin / 2 : o + i.width / 2 - d.actorMargin / 2), h && (r.message = H.wrapLabel(
    e.message,
  ...
  e.wrap && e.message && (e.message = H.wrapLabel(
    e.message,
