import { aD as s, aI as xt, aJ as E, d as j, bl as kt, Q as vt, R as bt, S as _t, b4 as wt, bm as St, b2 as Et } from "./vendor-CW5mw3QE.js";
import { d as nt } from "./arc-BrAQLIjU.js";
var K = (function() {
  var n = /* @__PURE__ */ s(function(x, r, a, c) {
    ...
    parse: /* @__PURE__ */ s(function(r) {
      var a = this, c = [0], u = [], y = [null], o = [], w = this.table, v = "", N = 0, P = 0, V = 2, U = 1, H = o.slice.call(arguments, 1), g = Object.create(this.lexer), _ = { yy: {} };
      for (var L in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, L) && (_.yy[L] = this.yy[L]);
      g.setInput(r, _.yy), _.yy.lexer = g, _.yy.parser = this, typeof g.yylloc > "u" && (g.yylloc = {});
      var M = g.yylloc;
      o.push(M);
      ...
      for (var S, A, I, J, R = {}, B, $, et, O; ; ) {
        if (A = c[c.length - 1], this.defaultActions[A] ? I = this.defaultActions[A] : ((S === null || typeof S > "u") && (S = tt()), I = w[A] && w[A][S]), typeof I > "u" || !I.length || !I[0]) {
          ...
          g.showPosition ? Q = "Parse error on line " + (N + 1) + `:
` + g.showPosition() + `
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : Q = "Parse error on line " + (N + 1) + ": Unexpected " + (S == U ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(Q, {
            text: g.match,
        ...
        switch (I[0]) {
          case 1:
            c.push(S), y.push(g.yytext), o.push(g.yylloc), c.push(I[1]), S = null, P = g.yyleng, v = g.yytext, N = g.yylineno, M = g.yylloc;
            break;
          case 2:
...
` + this.showPosition(), {
  ...
  return s(b, "Parser"), b.prototype = p, p.Parser = b, new b();
})();
K.parser = K;
var Tt = K, at = {};
wt(at, {
...
var F = "", lt = 0, X = [], G = [], z = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  X.length = 0, G.length = 0, F = "", z.length = 0, Et();
  ...
  function n(i, d, h, f, m, p, k, b) {
    const x = d.append("text").attr("x", h + m / 2).attr("y", f + p / 2 + 5).style("font-color", b).style("text-anchor", "middle").text(i);
    l(x, k);
  }
  s(n, "byText");
  function t(i, d, h, f, m, p, k, b, x) {
    const { taskFontSize: r, taskFontFamily: a } = b, c = i.split(/<br\s*\/?>/gi);
  ...
  function e(i, d, h, f, m, p, k, b) {
    ...
    a.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, x, h, f, m, p, k, b), l(a, k);
  }
  s(e, "byFo");
  function l(i, d) {
    for (const h in d)
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  p.append("g");
  const k = l.db.getTasks(), b = l.db.getCommonDb().getDiagramTitle();
  ...
  x.forEach(function(H) {
    const g = {
      ...
      padding: 20,
      maxHeight: r
    }, _ = C.getVirtualNodeHeight(p, g, i);
    E.debug("sectionHeight before draw", _), r = Math.max(r, _ + 20);
  });
  let N = 0, P = 0;
  ...
  for (const [H, g] of k.entries()) {
    const _ = {
      ...
      padding: 20,
      maxHeight: a
    }, L = C.getVirtualNodeHeight(p, _, i);
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), x && x.length > 0 ? x.forEach((H) => {
    ...
    const L = p.append("g"), M = C.drawNode(L, _, w, i);
  ...
  E.debug("bounds", V), b && p.append("text").text(b).attr("x", V.width / 2 - d).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = v ? r + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", d).attr("y1", c).attr("x2", V.width + 3 * d).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), kt(
    void 0,
    p,
  ...
  for (const b of t) {
    ...
    if (E.debug("taskHeight after draw", c), r.attr("transform", `translate(${l}, ${i})`), d = Math.max(d, c), b.events) {
      const u = n.append("g").attr("class", "lineWrapper");
      let y = d;
      i += 100, y = y + Bt(n, b.events, e, l, i, h), i -= 100, u.append("line").attr("x1", l + 190 / 2).attr("y1", i + d).attr("x2", l + 190 / 2).attr("y2", i + d + 100 + m + 100).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
    }
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], vt(n["lineColor" + e]) ? n["lineColor" + e] = bt(n["lineColor" + e], 20) : n["lineColor" + e] = _t(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const l = "" + (17 - 3 * e);
    t += `
