import { bW as q } from "./vendor-CW5mw3QE.js";
var B = { exports: {} }, V = { exports: {} }, k = { exports: {} }, tt = k.exports, K;
function et() {
    ...
    (function(C, T) {
      ...
      return (
        ...
        (function(R) {
          ...
          return T.m = R, T.c = C, T.i = function(o) {
            return o;
          }, T.d = function(o, e, t) {
          ...
          (function(R, C, T) {
            ...
            e.calcSeparationAmount = function(t, i, h, g) {
              ...
              var l = t.getX(), s = t.getY(), c = t.getRight(), v = t.getX(), L = t.getBottom(), p = t.getRight(), A = t.getWidthHalf(), E = t.getHeightHalf(), O = i.getX(), a = i.getY(), u = i.getRight(), f = i.getX(), y = i.getBottom(), D = i.getRight(), N = i.getWidthHalf(), I = i.getHeightHalf(), m = !1, M = !1;
              if (g === d) {
                if (n > r)
                ...
                var F = t.height / t.width, Y = i.height / i.width, w = (r - n) / (d - g), G = void 0, x = void 0, S = void 0, U = void 0, P = void 0, _ = void 0;
                if (-F === w ? g > d ? (h[0] = v, h[1] = L, m = !0) : (h[0] = c, h[1] = s, m = !0) : F === w && (g > d ? (h[0] = l, h[1] = s, m = !0) : (h[0] = p, h[1] = L, m = !0)), -Y === w ? d > g ? (h[2] = f, h[3] = y, M = !0) : (h[2] = u, h[3] = a, M = !0) : Y === w && (d > g ? (h[2] = O, h[3] = a, M = !0) : (h[2] = D, h[3] = y, M = !0)), m && M)
                  return !1;
                if (g > d ? n > r ? (G = this.getCardinalDirection(F, w, 4), x = this.getCardinalDirection(Y, w, 2)) : (G = this.getCardinalDirection(-F, w, 3), x = this.getCardinalDirection(-Y, w, 1)) : n > r ? (G = this.getCardinalDirection(-F, w, 1), x = this.getCardinalDirection(-Y, w, 3)) : (G = this.getCardinalDirection(F, w, 2), x = this.getCardinalDirection(Y, w, 4)), !m)
                  switch (G) {
                    case 1:
                ...
                if (!M)
                  switch (x) {
                    case 1:
                      _ = a, P = d + -I / w, h[2] = P, h[3] = _;
                      break;
                    case 2:
                      P = D, _ = r + N * w, h[2] = P, h[3] = _;
                      break;
                    case 3:
                      _ = y, P = d + I / w, h[2] = P, h[3] = _;
                      break;
                    case 4:
                      P = f, _ = r + -N * w, h[2] = P, h[3] = _;
                      break;
                  }
              }
              return !1;
          ...
          (function(R, C, T) {
            ...
            var t = function(d) {
              ...
              function n(d) {
                var r = this;
                e(this, n), this.length = 0, this.head = null, this.tail = null, d?.forEach(function(l) {
                  return r.push(l);
                });
              }
              return o(n, [{
    ...
    (function(C, T) {
      ...
      return (
        ...
        (function(C) {
          ...
          return o.m = C, o.c = T, o.i = function(e) {
            return e;
          }, o.d = function(e, t, i) {
          ...
          (function(C, T, o) {
            ...
            E.prototype.newGraphManager = function() {
                    ...
                    if (I = I.concat(D.getEdgeListToNode(N)), I = I.concat(N.getEdgeListToNode(D)), !u.has(I[0])) {
                      if (I.length > 1) {
                        ...
                        for (m = 0; m < I.length; m++) {
                          var M = I[m];
                          M.getBendpoints().push(new s()), this.createDummyNodesForBendpoints(M);
                        }
                      }
              ...
              for (var u = new l(0, 0), f = Math.ceil(Math.sqrt(a.length)), y = 0, D = 0, N = 0, I = new s(0, 0), m = 0; m < a.length; m++) {
                ...
                var M = a[m], F = c.findCenterOfTree(M);
                u.x = N, u.y = D, I = E.radialLayout(M, F, u), I.y > y && (y = Math.floor(I.y)), N = Math.floor(I.x + n.DEFAULT_COMPONENT_SEPERATION);
              }
              ...
              var M = new s(D.getMaxX(), D.getMaxY());
              return N.inverseTransformPoint(M);
            }, E.branchRadialLayout = function(a, u, f, y, D, N) {
              var I = (y - f + 1) / 2;
              I < 0 && (I += 180);
              var m = (I + f) % 360, M = m * L.TWO_PI / 360, F = D * Math.cos(M), Y = D * Math.sin(M);
              a.setCenter(F, Y);
              var w = [];
              w = w.concat(a.getEdges());
              var G = w.length;
              u != null && G--;
              for (var x = 0, S = w.length, U, P = a.getEdgesBetween(u); P.length > 1; ) {
                var _ = P[0];
                P.splice(0, 1);
                var X = w.indexOf(_);
                X >= 0 && w.splice(X, 1), S--, G--;
              }
              u != null ? U = (w.indexOf(P[0]) + 1) % S : U = 0;
              for (var b = Math.abs(y - f) / G, H = U; x != G; H = ++H % S) {
                var Z = w[H].getOtherEnd(a);
                if (Z != u) {
                  var Q = (f + x * b) % 360, j = (Q + b) % 360;
                  E.branchRadialLayout(Z, a, Q, j, D + N, N), x++;
                }
              }
              ...
              Object.keys(u).forEach(function(M) {
                if (u[M].length > 1) {
                  var F = "DummyCompound_" + M;
                  a.memberGroups[F] = u[M];
                  var Y = u[M][0].getParent(), w = new h(a.graphManager);
                  w.id = F, w.paddingLeft = Y.paddingLeft || 0, w.paddingRight = Y.paddingRight || 0, w.paddingBottom = Y.paddingBottom || 0, w.paddingTop = Y.paddingTop || 0, a.idToDummyNode[F] = w;
                  var G = a.getGraphManager().add(a.newGraph(), w), x = Y.getChild();
                  x.add(w);
                  for (var S = 0; S < u[M].length; S++) {
                    var U = u[M][S];
                    x.remove(U), G.add(U);
                  }
                }
              ...
              for (var N = u, I = 0; I < a.rows.length; I++) {
                var m = a.rows[I];
                u = N;
                for (var M = 0, F = 0; F < m.length; F++) {
                  var Y = m[F];
                  Y.rect.x = u, Y.rect.y = f, u += Y.rect.width + a.horizontalPadding, Y.rect.height > M && (M = Y.rect.height);
                }
                f += M + a.verticalPadding;
              }
              ...
              a.sort(function(m, M) {
                return m.rect.width * m.rect.height > M.rect.width * M.rect.height ? -1 : m.rect.width * m.rect.height < M.rect.width * M.rect.height ? 1 : 0;
              });
              ...
              var M = 0;
              m > a.rowHeight[f] && (M = a.rowHeight[f], a.rowHeight[f] = m, M = a.rowHeight[f] - M), a.height += M, a.rows[f].push(u);
              ...
              if (y < 0)
                return !0;
              var D = a.rowWidth[y];
              if (D + a.horizontalPadding + u <= a.width) return !0;
              var N = 0;
              ...
              if (a.width - a.rowWidth[f] > N && u != f) {
                ...
                var M = a.rowHeight[u] + a.rowHeight[f];
                ...
                a.height += F - M, this.shiftToLastRow(a);
              }
              ...
              var D = f.startX, N = f.finishX, I = f.startY, m = f.finishY, M = 0, F = 0, Y = 0, w = 0, G = [M, Y, F, w];
              if (I > 0)
                for (var x = D; x <= N; x++)
              ...
              for (var S = v.MAX_VALUE, U, P, _ = 0; _ < G.length; _++)
                G[_] < S ? (S = G[_], U = 1, P = _) : G[_] == S && U++;
              if (U == 3 && S == 0)
                G[0] == 0 && G[1] == 0 && G[2] == 0 ? u = 1 : G[0] == 0 && G[1] == 0 && G[3] == 0 ? u = 0 : G[0] == 0 && G[2] == 0 && G[3] == 0 ? u = 3 : G[1] == 0 && G[2] == 0 && G[3] == 0 && (u = 2);
              else if (U == 2 && S == 0) {
                var X = Math.floor(Math.random() * 2);
                G[0] == 0 && G[1] == 0 ? X == 0 ? u = 0 : u = 1 : G[0] == 0 && G[2] == 0 ? X == 0 ? u = 0 : u = 2 : G[0] == 0 && G[3] == 0 ? X == 0 ? u = 0 : u = 3 : G[1] == 0 && G[2] == 0 ? X == 0 ? u = 1 : u = 2 : G[1] == 0 && G[3] == 0 ? X == 0 ? u = 1 : u = 3 : X == 0 ? u = 2 : u = 3;
              } else if (U == 4 && S == 0) {
          ...
          (function(C, T, o) {
            var e = {};
            e.layoutBase = o(0), e.CoSEConstants = o(1), e.CoSEEdge = o(2), e.CoSEGraph = o(3), e.CoSEGraphManager = o(4), e.CoSELayout = o(6), e.CoSENode = o(5), C.exports = e;
          })
          /******/
        ])
      );
          ...
          (function(C, T, o) {
            ...
            s.prototype.run = function() {
              ...
              var M = function(w, G) {
                ...
                if (x) {
                  E.checkLayoutSuccess() && !E.isSubLayout && E.doPostLayout(), E.tilingPostLayout && E.tilingPostLayout(), E.isLayoutFinished = !0, O.options.eles.nodes().positions(M), w(), O.cy.one("layoutstop", O.options.stop), O.cy.trigger({ type: "layoutstop", layout: O }), p && cancelAnimationFrame(p), L = !1;
                  return;
                }
                var U = O.layout.getPositionsData();
                A.eles.nodes().positions(function(P, _) {
                  if (typeof P == "number" && (P = _), !P.isParent()) {
                    for (var X = P.id(), b = U[X], H = P; b == null && (b = U[H.data("parent")] || U["DummyCompound_" + H.data("parent")], U[X] = b, H = H.parent()[0], H != null); )
                      ;
                    return b != null ? {
                      x: b.x,
                      y: b.y
                ...
                }), w(), p = requestAnimationFrame(Y);
              };
              return E.addListener("layoutstarted", function() {
                O.options.animate === "during" && (p = requestAnimationFrame(F));
              }), E.runLayout(), this.options.animate !== "during" && (O.options.eles.nodes().not(":parent").layoutPositions(O, O.options, M), L = !1), this;
            ...
            typeof cytoscape < "u" && v(cytoscape), C.exports = v;
          })
          /******/
        ])
      );
