import { a0 as p, $ as u, ac as l, ae as n, a1 as m, aC as b, a4 as c, a6 as t, ag as a } from "./vendor-Dsy1-eqI.js";
const S = /* @__PURE__ */ m.deserialize({
  version: 14,
  ...
  tokenizers: [6, 7, /* @__PURE__ */ new a("b~RP#q#rU~XP#q#r[~aOT~~", 17, 4), /* @__PURE__ */ new a("!k~RQvwX#o#p!_~^TU~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOU~~![P;=`<%lm~!bP#o#p!e~!jOk~~", 72, 2), /* @__PURE__ */ new a("[~RPwxU~ZOp~~", 11, 15), /* @__PURE__ */ new a("[~RPrsU~ZOn~~", 11, 14), /* @__PURE__ */ new a("!e~RQvwXwx!_~^Tc~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOc~~![P;=`<%lm~!dOt~~", 66, 35), /* @__PURE__ */ new a("!e~RQrsXvw^~^Or~~cTb~Oprq!]r!^;'Sr;'S;=`!^<%lOr~uUOprq!]r!]!^!X!^;'Sr;'S;=`!^<%lOr~!^Ob~~!aP;=`<%lr~", 66, 33)],
  ...
  top: "Attribute"
}), y = { parser: Q }, R = { parser: g }, r = /* @__PURE__ */ l();
function i(O) {
  return O.configure({
    dialect: "selfClosing",
    wrap: n(X)
...
function f(O = {}) {
  ...
  return new u(e.language == r.language ? T : i(e.language), [
    e.support,
