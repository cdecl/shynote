import { ab as d, ac as g, $ as v, ad as m, a0 as u, ae as x, aa as b, a1 as G, a4 as Z, a2 as R, a3 as h, a6 as t, af as k, a7 as f, ag as w } from "./vendor-CW5mw3QE.js";
...
function A(O) {
  var i;
  let { state: a, pos: r } = O, e = b(a).resolveInner(r, -1).enterUnfinishedNodesBefore(r), P = ((i = e.childBefore(r)) === null || i === void 0 ? void 0 : i.name) || e.name;
...
const H = /* @__PURE__ */ d.inputHandler.of((O, i, a, r) => r != "%" || i != a || O.state.doc.sliceString(i - 1, a + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange((e) => ({
  changes: { from: e.from, to: e.to, insert: "%%" },
  range: m.cursor(e.from + 1)
})), {
  scrollIntoView: !0,
  ...
  parser: /* @__PURE__ */ F.configure({
    props: [
      /* @__PURE__ */ Z({
        ...
        self: t.self,
        "loop super": /* @__PURE__ */ t.standard(t.variableName),
        ...
        Definition: /* @__PURE__ */ t.definition(t.variableName),
        PropertyName: t.propertyName,
        FilterName: /* @__PURE__ */ t.special(t.variableName),
...
function c(O) {
  return B.configure({
    wrap: x((i) => i.type.isTop ? {
      parser: O.parser,
      overlay: (a) => a.name == "Text" || a.name == "RawText"
    } : null)
  }, "jinja");
}
