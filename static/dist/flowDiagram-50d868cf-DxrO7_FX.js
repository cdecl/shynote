import { f as $, p as kt } from "./flowDb-c6c81e3f-B8SmAQpS.js";
import { d as m, D as St, M as R, l as B, g as D, J as Lt, K as z, L as W, Y as Z, G as tt, k as et } from "./vendor-Dsy1-eqI.js";
import { G as Et } from "./graph-vxD8NXqM.js";
import { l as _t } from "./layout-CKZmpKt4.js";
import { b as T, c as rt, i as at, d as E, e as nt, g as st, f as Tt, a as Nt, s as At } from "./styles-d45a18b0-DyIYwln7.js";
import { u as Pt, r as Ct, p as It } from "./zipObject-C681kLsx.js";
import { e as I } from "./_basePickBy-5vNorB-z.js";
function Mt(r) {
  if (!r.ok) throw new Error(r.status + " " + r.statusText);
  return r.text();
}
function Bt(r, e) {
  return fetch(r, e).then(Mt);
}
function Dt(r) {
  return (e, t) => Bt(e, t).then((n) => new DOMParser().parseFromString(n, r));
}
var Gt = Dt("image/svg+xml"), V = {
  normal: Ot,
  vee: Ut,
  undirected: $t
};
...
function jt(r, e) {
  ...
  return s.unshift(Q(n, s[0])), s.push(Q(a, s[s.length - 1])), it(t, s);
}
function it(r, e) {
  var t = (St || Gt.line)().x(function(n) {
    return n.x;
  }).y(function(n) {
    return n.y;
  });
...
function Kt(r, e) {
  ...
  return t.append("path").attr("class", "path").attr("d", function(n) {
    var a = e.edge(n), s = e.node(n.v).elem, i = Ct(a.points.length).map(function() {
      return qt(s);
    });
    return it(a, i);
  }), t.append("defs"), t;
...
var F = function(r, e, t) {
  ...
  a.exit().remove(), a.enter().append("g").attr("class", "node").style("opacity", 0), a = r.selectAll("g.node"), a.each(function(i) {
    ...
    var d = c.append("g").attr("class", "label"), l = q(d, o), y = t[o.shape], h = It(l.node().getBBox(), "width", "height");
...
function ce() {
  var r = function(e, t) {
    ue(t);
    var n = M(e, "output"), a = M(n, "clusters"), s = M(n, "edgePaths"), i = H(M(n, "edgeLabels"), t), o = F(M(n, "nodes"), t, j);
    _t(t), ee(o, t), te(i, t), X(s, t, V);
    var c = Y(a, t);
    Zt(c, t), pe(t);
  };
...
const ve = {
  ...
  for (const d of c) {
    ...
    B.warn("Adding node", l.id, l.domId), e.setNode(s.db.lookUpDomId(l.id), {
      labelType: "svg",
...
`), i.style === void 0 && (l.style = l.style || "stroke: #333; stroke-width: 1.5px;fill:none"), l.labelStyle = l.labelStyle.replace("color:", "fill:"))), l.id = o, l.class = c + " " + d, l.minlen = i.length || 1, e.setEdge(t.db.lookUpDomId(i.start), t.db.lookUpDomId(i.end), l, n);
  ...
  return B.info("Extracting classes"), e.db.getClasses();
}, xe = async function(r, e, t, n) {
  B.info("Drawing flowchart");
  ...
  d === void 0 && (d = "TD");
  const l = s.nodeSpacing || 50, y = s.rankSpacing || 50, h = new Et({
    multigraph: !0,
    compound: !0
  }).setGraph({
    rankdir: d,
  ...
  B.warn("Get vertices", g);
  const p = n.db.getEdges();
  let v = 0;
  for (v = f.length - 1; v >= 0; v--) {
    u = f[v], At("cluster").append("text");
    ...
    if (b.link) {
      ...
      if (S) {
        ...
        const C = S.insert(function() {
          return x;
        }, ":first-child"), G = S.select(".label-container");
        G && C.append(function() {
          return G.node();
        });
