...
var Ve = (function() {
  var s = /* @__PURE__ */ A(function(O, o, c, d) {
    ...
    parse: /* @__PURE__ */ A(function(o) {
      var c = this, d = [0], n = [], g = [null], e = [], $ = this.table, t = "", oe = 0, ze = 0, qe = 2, Ye = 1, Je = e.slice.call(arguments, 1), T = Object.create(this.lexer), w = { yy: {} };
      ...
      for (var _, V, N, ve, R = {}, ce, x, Qe, he; ; ) {
        if (V = d[d.length - 1], this.defaultActions[V] ? N = this.defaultActions[V] : ((_ === null || typeof _ > "u") && (_ = Ke()), N = $[V] && $[V][_]), typeof N > "u" || !N.length || !N[0]) {
          ...
          he = [];
          for (ce in $[V])
            this.terminals_[ce] && ce > qe && he.push("'" + this.terminals_[ce] + "'");
...
Expecting ` + he.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : Ie = "Parse error on line " + (oe + 1) + ": Unexpected " + (_ == Ye ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(Ie, {
        ...
        switch (N[0]) {
          case 1:
            d.push(_), g.push(T.yytext), e.push(T.yylloc), d.push(N[1]), _ = null, ze = T.yyleng, t = T.yytext, oe = T.yylineno, xe = T.yylloc;
            break;
          case 2:
            if (x = this.productions_[N[1]][1], R.$ = g[g.length - x], R._$ = {
              ...
              return ve;
            x && (d = d.slice(0, -1 * x * 2), g = g.slice(0, -1 * x), e = e.slice(0, -1 * x)), d.push(this.productions_[N[1]][0]), g.push(R.$), e.push(R._$), Qe = $[d[d.length - 2]][d[d.length - 1]], d.push(Qe);
            break;
          case 3:
            return !0;
        }
