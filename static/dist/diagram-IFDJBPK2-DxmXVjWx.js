import { aD as l, aE as k, aF as R, aY as E, aX as F, aG as I, aH as D, ba as _, b2 as G, b6 as y, b7 as b, b8 as z, aJ as P, bc as W, aK as B } from "./vendor-CW5mw3QE.js";
import { p as H } from "./chunk-4BX2VUAB-akHX38MJ.js";
import { p as V } from "./treemap-KZPCXAKY-C0qkw44J.js";
var h = {
  showLegend: !0,
  ticks: 5,
  max: null,
  ...
  curves: [],
  options: h
}, x = structuredClone(C), j = z.radar, X = /* @__PURE__ */ l(() => y({
  ...j,
  ...b().radar
}), "getConfig"), w = /* @__PURE__ */ l(() => x.axes, "getAxes"), Y = /* @__PURE__ */ l(() => x.curves, "getCurves"), J = /* @__PURE__ */ l(() => x.options, "getOptions"), K = /* @__PURE__ */ l((a) => {
  x.axes = a.map((t) => ({
    name: t.name,
