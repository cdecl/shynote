import { aD as o, aJ as te, aI as H, ba as fe, bn as ye, bo as be, bp as me, bl as _e, b8 as K, aN as F, aZ as ke, a_ as Ee, Q as Se, R as ce, S as le } from "./vendor-Dsy1-eqI.js";
import { g as Ne } from "./chunk-FMBD7UC4-CC3FZtNG.js";
var $ = (function() {
    ...
    parse: /* @__PURE__ */ o(function(i) {
      ...
      for (var E, P, x, Z, j = {}, z, C, oe, X; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((E === null || typeof E > "u") && (E = ae()), x = U[P] && U[P][E]), typeof x > "u" || !x.length || !x[0]) {
          ...
          y.showPosition ? q = "Parse error on line " + (W + 1) + `:
` + y.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : q = "Parse error on line " + (W + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(q, {
            text: y.match,
        ...
        switch (x[0]) {
          case 1:
            r.push(E), h.push(y.yytext), t.push(y.yylloc), r.push(x[1]), E = null, se = y.yyleng, c = y.yytext, W = y.yylineno, Q = y.yylloc;
            break;
          case 2:
...
var xe = $, v = [], ne = [], ee = 0, ie = {}, ve = /* @__PURE__ */ o(() => {
  ...
  const k = H();
  let b = k.mindmap?.padding ?? K.mindmap.padding;
  switch (s) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
