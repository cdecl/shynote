import { aD as b, b6 as m, ba as B, aK as C, aJ as w, aH as S, aG as D, aX as T, aY as E, aF as F, aE as P, b7 as z, b8 as A, b2 as W } from "./vendor-CW5mw3QE.js";
import { p as _ } from "./chunk-4BX2VUAB-akHX38MJ.js";
import { p as N } from "./treemap-KZPCXAKY-C0qkw44J.js";
var Y = A.packet, u, v = (u = class {
  ...
  for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
    ...
    for (i ??= a + (d ?? 1) - 1, d ??= i - a + 1, r = i, w.debug(`Packet block ${a} - ${r} with label ${c}`); s.length <= l + 1 && t.getPacket().length < L; ) {
