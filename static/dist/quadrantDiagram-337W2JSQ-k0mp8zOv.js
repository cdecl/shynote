...
var Et = (function() {
  var t = /* @__PURE__ */ o(function(M, r, l, x) {
    ...
    parse: /* @__PURE__ */ o(function(r) {
      var l = this, x = [0], c = [], S = [null], e = [], ut = this.table, s = "", yt = 0, Jt = 0, qe = 2, Zt = 1, me = e.slice.call(arguments, 1), E = Object.create(this.lexer), Y = { yy: {} };
      ...
      function $t() {
        var B;
        return B = c.pop() || E.lex() || Zt, typeof B != "number" && (B instanceof Array && (c = B, B = c.pop()), B = l.symbols_[B] || B), B;
      }
      o($t, "lex");
...
` + E.showPosition() + `
Expecting ` + qt.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Ct = "Parse error on line " + (yt + 1) + ": Unexpected " + (w == Zt ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Ct, {
            text: E.match,
        ...
        switch (N[0]) {
          case 1:
            x.push(w), S.push(E.yytext), e.push(E.yylloc), x.push(N[1]), w = null, Jt = E.yyleng, s = E.yytext, yt = E.yylineno, Pt = E.yylloc;
            break;
          case 2:
