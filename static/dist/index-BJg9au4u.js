import { bb as W, bh as i, be as U, bp as B, bg as n, ba as y, b9 as k, bw as u, bc as E, bd as M, bm as v, bo as N } from "./vendor-T05Wpcog.js";
...
const fO = new i((O, e) => {
  ...
  if (O.next == 45)
    O.advance(), l(O.next) && O.acceptToken(e.context.type == T && e.context.depth == X(O, O.pos - 1) ? H : C);
  else if (O.next == 63)
...
function w(O, e, a, r) {
  ...
  for (; ; ) {
    ...
    if (!(t >= 0 && (t == 58 ? b(O.peek(Q + 1), a) : t == 35 ? O.peek(Q - 1) != 32 : b(t, a))) || !a && R <= r || R == 0 && !a && (f(O, 45, Q) || f(O, 46, Q)))
      break;
    if (e && S(t) == "f") return !1;
...
function hO(O) {
  let { language: e, support: a } = O.content instanceof k ? O.content : { language: O.content, support: [] };
  return new k(xO.configure({
    wrap: u((r) => r.name == "FrontmatterContent" ? { parser: L.parser } : r.name == "Body" ? { parser: e.parser } : null)
  }), a);
}
export {
  pO as yaml,
