import { R as Ge, J as Sn, K as je, L as $e, M as Je, N as ne, O as _n, P as Te, a as Yn, s as Un, C as Fn, D as En, b as Ln, c as An, g as Dt, d as Rt, e as Wn, Q as nt, l as $t, k as In, j as On, E as Hn, B as Nn } from "./vendor-r1U8Lk84.js";
import { b as Pn, t as Fe, c as Vn, a as zn, l as Rn } from "./linear-Dr6twDfB.js";
import { i as Bn } from "./init-DjUOC4st.js";
function Zn(t, e) {
  let n;
  if (e === void 0)
    for (const r of t)
...
function Ke(t, e) {
  ...
  function w(T) {
    var X = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()), W = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : Xn), D = Math.max(s, 0) + y, E = e.range(), H = +E[0] + S, L = +E[E.length - 1] + S, Z = (e.bandwidth ? $n : jn)(e.copy(), S), j = T.selection ? T.selection() : T, b = j.selectAll(".domain").data([null]), I = j.selectAll(".tick").data(X, e).order(), v = I.exit(), U = I.enter().append("g").attr("class", "tick"), _ = I.select("line"), x = I.select("text");
    b = b.merge(b.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), I = I.merge(U), _ = _.merge(U.append("line").attr("stroke", "currentColor").attr(g + "2", p * s)), x = x.merge(U.append("text").attr("fill", "currentColor").attr(g, p * D).attr("dy", t === Zt ? "0em" : t === de ? "0.71em" : "0.32em")), T !== j && (b = b.transition(T), I = I.transition(T), _ = _.transition(T), x = x.transition(T), v = v.transition(T).attr("opacity", Ee).attr("transform", function(o) {
      ...
      return F(Z(o) + S);
    }), _.attr(g + "2", p * s), x.attr(g, p * D).text(W), j.filter(Jn).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === re ? "start" : t === Bt ? "end" : "middle"), j.each(function() {
      this.__axis = Z;
    });
  }
  ...
  function b(k, A) {
    return function(Y) {
      ...
      for (Y instanceof Date || (Y = /* @__PURE__ */ new Date(+Y)); ++B < G; )
        k.charCodeAt(B) === 37 && (l.push(k.slice(P, B)), (J = Ae[$ = k.charAt(++B)]) != null ? $ = k.charAt(++B) : J = $ === "e" ? " " : "0", (ct = A[$]) && ($ = ct(Y, J)), l.push($), P = B + 1);
  ...
  function v(k, A, Y, l) {
    for (var B = 0, P = A.length, G = Y.length, $, J; B < P; ) {
      ...
      if ($ = A.charCodeAt(B++), $ === 37) {
        if ($ = A.charAt(B++), J = j[$ in Ae ? A.charAt(B++) : $], !J || (l = J(k, Y, l)) < 0) return -1;
          ...
          if (typeof U == "string") {
            ...
            x && (f = v[2]), S = this.$locale(), !_ && f && (S = H.Ls[f]), this.$d = (function(c, Q, d, h) {
              try {
                ...
                var G, $ = N || 0, J = z || 0, ct = at || 0, yt = ot || 0;
    ...
    parse: function(o) {
      ...
      for (var Y, l, B, P, G = {}, $, J, ct, yt; ; ) {
        if (l = m[m.length - 1], this.defaultActions[l] ? B = this.defaultActions[l] : ((Y === null || typeof Y > "u") && (Y = A()), B = Q[l] && Q[l][Y]), typeof B > "u" || !B.length || !B[0]) {
          ...
          yt = [];
          for ($ in Q[l])
            this.terminals_[$] && $ > q && yt.push("'" + this.terminals_[$] + "'");
...
Expecting ` + yt.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : zt = "Parse error on line " + (h + 1) + ": Unexpected " + (Y == O ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(zt, {
        ...
        switch (B[0]) {
          case 1:
            ...
            break;
          case 2:
            if (J = this.productions_[B[1]][1], G.$ = M[M.length - J], G._$ = {
              ...
              return P;
            J && (m = m.slice(0, -1 * J * 2), M = M.slice(0, -1 * J), c = c.slice(0, -1 * J)), m.push(this.productions_[B[1]][0]), M.push(G.$), c.push(G._$), ct = Q[m[m.length - 2]][m[m.length - 1]], m.push(ct);
            break;
          case 3:
            return !0;
        }
