import { Q as gt, R as ft, S as mt, g as xt, l as E, d as G, J as _t, T as bt, r as kt } from "./vendor-CW5mw3QE.js";
import { d as D } from "./arc-BrAQLIjU.js";
var Q = (function() {
...
const vt = Q;
let F = "", st = 0;
const K = [], q = [], V = [], it = () => bt, rt = function() {
  K.length = 0, q.length = 0, F = "", V.length = 0, kt();
}, at = function(n) {
  F = n, K.push(n);
}, lt = function() {
  return K;
