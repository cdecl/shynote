import { aD as w, bF as j, bG as H, bH as Y, bI as _, aJ as i, aI as V, bJ as K, bK as U, bo as $, bu as q, bp as P, bn as z, bL as Q, bM as W, bN as Z } from "./vendor-Dsy1-eqI.js";
import { G as B } from "./graph-BNeFSKWr.js";
import { l as I } from "./layout-CUbTTPKT.js";
import { i as N } from "./_baseUniq-2ZdiQU8D.js";
import { c as L } from "./clone-vl_Qg_aI.js";
import { m as J } from "./_basePickBy-5vNorB-z.js";
function h(e) {
  var t = {
    options: {
  ...
  return N(e.graph()) || (t.value = L(e.graph())), t;
}
function ee(e) {
...
var d = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), te = /* @__PURE__ */ w(() => {
  X.clear(), A.clear(), d.clear();
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (i.warn(
      ...
      C(n, e, n)
    ), X.set(n, R(n, e)), d.set(n, { id: C(n, e, n), clusterData: e.node(n) }));
  }), e.nodes().forEach(function(n) {
...
}, "sorter"), oe = /* @__PURE__ */ w((e) => M(e, e.children()), "sortNodesByHierarchy"), F = /* @__PURE__ */ w(async (e, t, n, a, r, o) => {
...
Parent cluster`,
      ...
      if (i.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode) {
        ...
        t.children(f).length > 0 ? (i.trace(
          ...
          "Graph:",
          t
        ), i.trace(C(s.id, t)), d.set(s.id, { id: C(s.id, t), node: s })) : (i.trace("Node - the non recursive path XAX", f, b, t.node(f), l), await $(b, t.node(f), { config: o, dir: l }));
    })
  ...
  return await Promise.all(
    oe(t).map(async function(f) {
      ...
      if (i.info(
        ...
        const g = s?.padding / 2 || 0, y = s?.labelBBox?.height || 0, E = y - g || 0;
        i.debug("OffsetY", E, "labelHeight", y, "halfPadding", g), await z(c, s), d.get(s.id).node = s;
      } else {
  ...
  j(a, e.markers, e.type, e.diagramId), H(), Y(), _(), te(), e.nodes.forEach((o) => {
    ...
    if (o.start === o.end) {
      ...
      const v = structuredClone(o), b = structuredClone(o), p = structuredClone(o);
      v.label = "", v.arrowTypeEnd = "none", v.id = l + "-cyclic-special-1", b.arrowTypeStart = "none", b.arrowTypeEnd = "none", b.id = l + "-cyclic-special-mid", p.label = "", m.isGroup && (v.fromCluster = l, p.toCluster = l), p.id = l + "-cyclic-special-2", p.arrowTypeStart = "none", n.setEdge(l, u, v, l + "-cyclic-special-0"), n.setEdge(u, c, b, l + "-cyclic-special-1"), n.setEdge(c, l, p, l + "-cyc<lic-special-2");
    } else
