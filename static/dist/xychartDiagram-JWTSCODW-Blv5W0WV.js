import { aD as n, aE as gi, aF as xi, aY as Xt, aX as di, aG as pi, aH as fi, aJ as Nt, ba as yi, aK as mi, b2 as bi, b7 as Ct, b6 as Yt, b8 as Ai, bc as wi, aN as Ci, bd as Si, D as Bt } from "./vendor-CW5mw3QE.js";
import { b as Wt } from "./band-m4Y6N7d9.js";
import { l as zt } from "./linear-BVvpQzMY.js";
var mt = (function() {
...
Expecting ` + ut.join(", ") + ", got '" + (this.terminals_[T] || T) + "'" : yt = "Parse error on line " + (lt + 1) + ": Unexpected " + (T == It ? "end of input" : "'" + (this.terminals_[T] || T) + "'"), this.parseError(yt, {
        ...
        switch (E[0]) {
          case 1:
            ...
            break;
          case 2:
            if (O = this.productions_[E[1]][1], G.$ = A[A.length - O], G._$ = {
              ...
              return ft;
            O && (g = g.slice(0, -1 * O * 2), A = A.slice(0, -1 * O), o = o.slice(0, -1 * O)), g.push(this.productions_[E[1]][0]), A.push(G.$), o.push(G._$), Mt = nt[g[g.length - 2]][g[g.length - 1]], g.push(Mt);
            break;
          case 3:
            return !0;
        }
...
}, n(K, "BandAxis"), K), J, Ti = (J = class extends Ut {
  constructor(t, i, e, a, c) {
...
function ai() {
  ...
  return y.title = Xt(), Ei.build(rt, y, ht, qt);
}
