import { a1 as G, a7 as z, a4 as N, bA as I, a6 as p, ab as Y, a0 as j, $ as U, aa as k, ad as Z, a2 as B, a3 as D, bE as M } from "./vendor-CW5mw3QE.js";
    ...
    e: for (; !(o.next < 0); o.advance(), O++)
      if (o.next == r) {
        for (let n = 1; n < t.length; n++)
          if (o.peek(n) != t.charCodeAt(n)) continue e;
        break;
      }
    O && o.acceptToken(e);
  });
...
function ge(e, t) {
  ...
  for (let n = O; !r && n.parent; n = n.parent)
    (n.name == "OpenTag" || n.name == "CloseTag" || n.name == "SelfClosingTag" || n.name == "MismatchedCloseTag") && (r = n);
  if (r && (r.to > t || r.lastChild.type.isError)) {
    let n = r.parent;
    if (O.name == "TagName")
      return r.name == "CloseTag" || r.name == "MismatchedCloseTag" ? { type: "closeTag", from: O.from, context: n } : { type: "openTag", from: O.from, context: C(n) };
    ...
    return s?.name == "StartTag" ? { type: "openTag", from: t, context: C(n) } : s?.name == "StartCloseTag" && s.to <= t ? { type: "closeTag", from: t, context: n } : s?.name == "Is" ? { type: "attrValue", from: t, context: r } : s ? { type: "attrName", from: t, context: r } : null;
...
function pe(e, t) {
  ...
  for (let a of t) {
    let m = E(a);
    o.push(m), a.global && O.push(m), a.values && (r[a.name] = a.values.map(R));
  }
  let n = [], s = [], f = /* @__PURE__ */ Object.create(null);
  for (let a of e) {
    let m = O, c = r;
    a.attributes && (m = m.concat(a.attributes.map((l) => typeof l == "string" ? o.find((d) => d.label == l) || { label: l, type: "property" } : (l.values && (c == r && (c = Object.create(c)), c[l.name] = l.values.map(R)), E(l)))));
    let u = new ue(a, m, c);
  ...
  return (a) => {
    ...
    if (l == "openTag") {
      ...
      let v = g.concat(($?.children || (S ? n : s)).map((x) => x.openCompletion));
      if (S && $?.text.length) {
        let x = S.firstChild;
        x.to > a.pos - 20 && !/\S/.test(a.state.sliceDoc(x.to, a.pos)) && (v = v.concat($.text));
      }
      return {
        from: d,
        options: v,
...
const fe = /* @__PURE__ */ Y.inputHandler.of((e, t, o, O, r) => {
  ...
  let n = r(), { state: s } = n, f = s.changeByRange((a) => {
    ...
    if (d && O == ">" && S.name == "EndTag") {
      let $ = S.parent;
      if (((c = (m = $.parent) === null || m === void 0 ? void 0 : m.lastChild) === null || c === void 0 ? void 0 : c.name) != "CloseTag" && (i = A(s.doc, $.parent, l))) {
        let g = l + (s.doc.sliceString(l, l + 1) === ">" ? 1 : 0), q = `</${i}>`;
        return { range: a, changes: { from: l, to: g, insert: q } };
      }
    } else if (d && O == "/" && S.name == "StartCloseTag") {
      let $ = S.parent;
      if (S.from == l - 2 && ((u = $.lastChild) === null || u === void 0 ? void 0 : u.name) != "CloseTag" && (i = A(s.doc, $, l))) {
        let g = l + (s.doc.sliceString(l, l + 1) === ">" ? 1 : 0), q = `${i}>`;
        return {
