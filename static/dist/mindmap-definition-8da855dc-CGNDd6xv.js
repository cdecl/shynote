import { P as yv, l as Nr, as as mv, at as bv, au as wv, g as ao, T as Ev, o as xv, X as Cn, i as Dn, d as Tv, W as Cv } from "./vendor-r1U8Lk84.js";
import { a as Dv } from "./createText-1719965b-BKgslIHF.js";
function Bs(t, e) {
...
function Lv(t, e) {
  for (var r = 0; r < e.length; r++) {
    var a = e[r];
    a.enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(t, df(a.key), a);
  }
}
function mr(t, e, r) {
...
var kv = nt(""), gf = nt({}), Nv = nt(function() {
  ...
  return e != null && nt(e) === gf && !Ve(e) && e.constructor === Object;
}, Fv = function(e) {
  return e != null && nt(e) === gf;
}, ne = function(e) {
...
function lh() {
  if (Ko) return mi;
  Ko = 1;
  var t = ih(), e = Ga(), r = za(), a = NaN, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
  function u(l) {
    if (typeof l == "number")
      return l;
    if (r(l))
...
var ch = fh(), Va = /* @__PURE__ */ _a(ch), wi = tt ? tt.performance : null, Cf = wi && wi.now ? function() {
  return wi.now();
} : function() {
  return Date.now();
}, vh = (function() {
...
var Jo = !0, mh = console.warn != null, bh = console.trace != null, uo = Number.MAX_SAFE_INTEGER || 9007199254740991, Lf = function() {
  return !0;
}, Rn = function() {
  return !1;
}, jo = function() {
  ...
  Rf() && (mh ? console.warn(e) : (console.log(e), bh && console.trace()));
}, wh = function(e) {
  return be({}, e);
}, Ut = function(e) {
...
}, ed = (Ti = Math.hypot) !== null && Ti !== void 0 ? Ti : function(t, e) {
...
var Nf = function(e, r, a, n, i, s, o) {
  ...
  var l = 1 * a * a - 4 * a * i + 2 * a * o + 4 * i * i - 4 * i * o + o * o + n * n - 4 * n * s + 2 * n * u + 4 * s * s - 4 * s * u + u * u, f = 9 * a * i - 3 * a * a - 3 * a * o - 6 * i * i + 3 * i * o + 9 * n * s - 3 * n * n - 3 * n * u - 6 * s * s + 3 * s * u, c = 3 * a * a - 6 * a * i + a * o - a * e + 2 * i * i + 2 * i * e - o * e + 3 * n * n - 6 * n * s + n * u - n * r + 2 * s * s + 2 * s * r - u * r, v = 1 * a * i - a * a + a * e - i * e + n * s - n * n + n * r - s * r, h = [];
  sd(l, f, c, v, h);
  ...
  if (b !== 0) {
    ...
    return g === 0 || y === 0 ? Ci(e, a, o) === o ? [o, u] : Ci(e, a, i) === i ? [i, s] : Ci(i, o, a) === a ? [a, n] : [] : [];
...
var Md = ht({
  ...
  for (var n = 0, i = 0; i < r.length; i++)
    n += Mn("manhattan", r[i], e, a, "kMedoids");
  return n;
}, Bd = function(e) {
  ...
  for (var l = !0, f = 0; l && f < i.maxIterations; ) {
    for (var c = 0; c < a.length; c++)
      n = a[c], o[n.id()] = zf(n, u, i.distance, i.attributes, "kMeans");
    l = !1;
    for (var v = 0; v < i.k; v++) {
      var h = Vf(v, a, o);
      if (h.length !== 0) {
  ...
  for (var c = !0, v = 0; c && v < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], u[n.id()] = zf(n, o, i.distance, i.attributes, "kMedoids");
    c = !1;
  ...
  for (var o, u, l, f = 2 / (i.m - 1), c = 0; c < a.length; c++)
    for (var v = 0; v < n.length; v++) {
      o = 0;
      for (var h = 0; h < a.length; h++)
        u = Mn(i.distance, n[v], a[c], i.attributes, "cmeans"), l = Mn(i.distance, n[v], a[h], i.attributes, "cmeans"), o += Math.pow(u / l, f);
      e[v][c] = 1 / o;
    }
}, zd = function(e, r, a, n) {
  ...
  if (!e) return "";
  if (e.left && e.right) {
    var a = zs(e.left, r), n = zs(e.right, r), i = r.add({
      group: "nodes",
      data: {
        id: a + "," + n
      }
...
function ig() {
  if (xu) return Ri;
  xu = 1;
  var t = Tf(), e = Ga(), r = "[object AsyncFunction]", a = "[object Function]", n = "[object GeneratorFunction]", i = "[object Proxy]";
  function s(o) {
    if (!e(o))
      return !1;
    var u = t(o);
...
var Bg = Ng(), Fg = /* @__PURE__ */ _a(Bg), ps, ll;
function _g() {
  if (ll) return ps;
  ll = 1;
  var t = yo(), e = (function() {
...
function zg() {
  if (cl) return ms;
  cl = 1;
  var t = Gg(), e = Wf(), r = Object.prototype, a = r.hasOwnProperty;
  function n(i, s, o) {
    var u = i[s];
...
var ze = function() {
  ...
  for (var t = {}, e, r = 0; r < qs.length; r++)
    e = qs[r], t[e.selector] = e.matches;
  return t;
})(), ep = function(e, r) {
  return jg[e](r);
}, tp = "(" + qs.map(function(t) {
  return t.selector;
}).join("|") + ")", Gr = function(e) {
    ...
    if (a && a.isNode())
      if (u)
        for (var l = 0; l < this.length; l++) {
          var f = this[l];
          r !== void 0 ? f.position(e, (r - s[e]) / i) : o !== void 0 && f.position(Mf(o, i, s));
        }
      else {
        var c = a.position();
...
var It = function(e) {
  ...
  if (!r.cy().headless()) {
    ...
    ic(e, r, a, s, "outside", s / 2);
  }
}, ic = function(e, r, a, n, i, s) {
  if (!(a === 0 || n <= 0 || i === "inside")) {
  ...
  var a = e._private, n, i = e.isEdge(), s = r == null ? wl : sc(r), o = s === wl;
  if (a.bbCache == null ? (n = yp(e, Ma), a.bbCache = n, a.bbCachePosKey = oc(e)) : n = a.bbCache, !o) {
    var u = e.isNode();
...
br.boundingBox = function(t) {
  var e, r = t === void 0 || t.useCache === void 0 || t.useCache === !0, a = ta(function(f) {
    var c = f._private;
    return c.bbCache == null || c.styleDirty || c.bbCachePosKey !== oc(f);
  }, function(f) {
    return f.id();
  });
...
var gr = Zn.prototype, vc = function(e, r, a, n, i, s, o) {
  ...
  return e.addEventFields(e.context, r), new lc(r.type, r);
}, Op = function(e, r, a) {
  if (Gv(a)) {
    r(e, a);
    return;
...
var kp = {
  ...
  createEmitter: function() {
    for (var e = 0; e < this.length; e++) {
      ...
      a.emitter || (a.emitter = new Zn(kp, r));
    }
    return this;
  },
  emitter: function() {
...
ct.takesUpSpace = Jn("takesUpSpace", Eo({
  ok: sa
}));
var _p = Qn("eleInteractive", function(t) {
  return t.pstyle("events").value === "yes" && t.pstyle("visibility").value === "visible" && sa(t);
}), Gp = Qn("parentInteractive", function(t) {
  return t.pstyle("visibility").value === "visible" && sa(t);
});
ct.interactive = Jn("interactive", Eo({
  ok: _p,
  parentOk: Gp,
  edgeOkViaNode: sa
}));
...
qe.collection = function() {
  return pf(this) ? this : new vt(this._private.cy, [this]);
};
qe.unique = function() {
...
var Xp = {
  ...
  createEmitter: function() {
    var e = this._private;
    return e.emitter || (e.emitter = new Zn(Wp, this)), this;
  },
  emitter: function() {
    return this._private.emitter;
  },
...
yt.append = function(t) {
  return yf(t) ? t.appendToStyle(this) : Ve(t) ? this.appendFromJson(t) : ge(t) && this.appendFromString(t), this;
};
...
var Jp = {
  ...
  setStyle: function(e) {
    var r = this._private;
    return yf(e) ? r.style = e.generateStyle(this) : Ve(e) ? r.style = ut.fromJson(this, e) : ge(e) ? r.style = ut.fromString(this, e) : r.style = ut(this), r.style;
  },
  ...
  getZoomedViewport: function(e) {
    ...
    if (r.zoomingEnabled || (o = !0), ne(e) ? s = e : Oe(e) && (s = e.level, e.position != null ? i = qn(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = !0)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !ne(s) || s === n || i != null && (!ne(i.x) || !ne(i.y)))
      return null;
    if (i != null) {
      var u = a, l = n, f = s, c = {
        x: -f / l * (i.x - u.x) + i.x,
...
be(kn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !An(e) && An(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = !0, r.invalidateSize(), r.initRenderer(be({}, n, n.renderer, {
...
var iy = function(e, r, a) {
  ...
  for (var s = 0, o = 0; o < i.length; o++) {
    ...
    if (f.length !== 0) {
      var c = n.indexToGraph[n.idToIndex[f[0]]], v = Ec(e, r, c, n);
      if (v.count !== 0)
        if (v.count === 1) {
          if (s++, s === 2)
            break;
  ...
  var n = a.layout, i = a.eles.nodes(), s = xc(e, a, i);
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    if (f > 0)
      ...
      var p = Nn(e, o, u), g = Nn(r, -1 * o, -1 * u), y = g.x - p.x, b = g.y - p.y, m = y * y + b * b, v = Math.sqrt(m), c = (e.nodeRepulsion + r.nodeRepulsion) / m, h = c * y / v, d = c * b / v;
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      ...
      n.positionX += i.x, n.positionY += i.y, n.offsetX = 0, n.offsetY = 0, n.minX = n.positionX - n.width, n.maxX = n.positionX + n.width, n.minY = n.positionY - n.height, n.maxY = n.positionY + n.height, Tc(n, e);
    }
  }
  for (var a = 0; a < e.nodeSize; a++) {
    var n = e.layoutNodes[a];
...
$t.recalculateEdgeLabelProjections = function(t) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var o = Mc(a.midDispX, a.midDispY);
...
ai.getCachedZSortedEles = function(t) {
  if (t || !this.cachedZSortedEles) {
    ...
    e.sort(gc), e.interactive = e.filter(function(r) {
...
var Bc = {};
Bc.getCachedImage = function(t, e, r) {
...
jt.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, r, a, n, i, s, o, u) {
      ...
      return h.length > 0 ? h : Nf(i, s, e, r, a, n, o, u);
    },
    checkPoint: function(e, r, a, n, i, s, o, u) {
      u = u === "auto" ? vr(n, i) : u;
      var l = 2 * u;
...
it.setupDequeueing = _c.setupDequeueing({
...
}, dt = zc.prototype, Zl = 0, rm = Math.pow(2, 53) - 1;
...
dt.getLayers = function(t, e, r) {
  ...
  var u = a.layersByLevel, l = Math.pow(2, r), f = u[r] = u[r] || [], c, v = a.levelIsComplete(r, t), h, d = function() {
    var D = function(M) {
      ...
      if (!h)
        for (var N = r + M; Ca <= N && N <= Fn && !D(N); N += M)
          ;
    };
    A(1), A(-1);
  ...
  for (var y = null, b = t.length / Yy, m = !o, E = 0; E < t.length; E++) {
    ...
    if ((!y || y.eles.length >= b || !kf(y.bb, T.boundingBox())) && (y = g({
      insert: !0,
      after: y
    }), !y))
      return null;
...
dt.updateElementsInLayers = function(t, e) {
  for (var r = this, a = Fa(t[0]), n = 0; n < t.length; n++)
    for (var i = a ? null : t[n], s = a ? t[n] : t[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = Ca; l <= Fn; l++) {
      var f = u[l];
      f && (i && r.getEleLevelForLayerLevel(f.level) !== i.level || e(f, s, i));
    }
};
dt.haveLayers = function() {
  for (var t = this, e = !1, r = Ca; r <= Fn; r++) {
...
er.drawEdgeOverlay = Uc("overlay");
er.drawEdgeUnderlay = Uc("underlay");
...
wr.drawNodeOverlay = qc("overlay");
wr.drawNodeUnderlay = qc("underlay");
...
function Cm(t, e, r) {
  ...
  for (var l = 0; l < 3; l++) {
    var f = r + l;
    t.enableVertexAttribArray(f), t.vertexAttribPointer(f, 3, t.FLOAT, !1, 36, l * 12), t.vertexAttribDivisor(f, 1);
  }
...
Hc.initWebgl = function(t, e) {
  ...
  r.drawing.addAtlasCollection("node", {
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Os(e.getSourceLabelKey, "source"),
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Os(e.getTargetLabelKey, "target"),
...
function Gm(t) {
  {
    ...
    t.render = function(i) {
      i = i || {};
      var s = t.cy;
      t.webgl && (s.zoom() > Gc ? (zm(t), e.call(t, i)) : (Vm(t), Kc(t, i, Da.SCREEN)));
    };
  }
  {
...
function Hm(t, e, r, a, n) {
  ...
  y.bindFramebuffer(y.FRAMEBUFFER, t.pickingFrameBuffer), t.pickingFrameBuffer.needsDraw && (y.viewport(0, 0, y.canvas.width, y.canvas.height), Kc(t, null, Da.PICKING), t.pickingFrameBuffer.needsDraw = !1);
...
Er.drawEllipsePath = function(t, e, r, a, n) {
  if (t.beginPath && t.beginPath(), t.ellipse)
    ...
    for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += Zc)
...
function rv(t, e, r) {
  ...
  if (t === "core") {
    ...
    var h = av("renderer", "base"), d = h.prototype, p = r, g = r.prototype, y = function() {
...
var En = { exports: {} }, xn = { exports: {} }, Tn = { exports: {} }, r0 = Tn.exports, ff;
function a0() {
        ...
        (function(r) {
          ...
          (function(r, a, n) {
            ...
            var o = function(v) {
              ...
              function c(v) {
                var h = this;
                s(this, c), this.length = 0, this.head = null, this.tail = null, v?.forEach(function(d) {
                  return h.push(d);
                });
              }
              return i(c, [{
...
const c0 = () => {
  ...
  for (let e = Ft.length - 1; e >= 0; e--)
    if (Ft[e].level < t)
      return Ft[e];
  return null;
}, h0 = () => Ft.length > 0 ? Ft[0] : null, d0 = (t, e, r, a) => {
  var n, i;
  ...
  const u = {
    ...
    type: a,
    children: [],
    width: ((i = s.mindmap) == null ? void 0 : i.maxNodeWidth) ?? Cn.mindmap.maxNodeWidth,
    padding: o
  }, l = v0(t);
  if (l)
  ...
  getLogger: b0,
  getElementById: w0
}, x0 = E0, T0 = 12, C0 = function(t, e, r, a) {
  e.append("path").attr("id", "node-" + r.id).attr("class", "node-bkg node-" + t.type2Str(r.type)).attr(
    "d",
    `M0 ${r.height - 5} v${-r.height + 10} q0,-5 5,-5 h${r.width - 10} q5,0 5,5 v${r.height - 5} H0 Z`
...
`);
  ...
  switch (r.type) {
    ...
    case t.nodeType.CIRCLE:
      l.attr("transform", "translate(" + r.width / 2 + ", " + +r.height / 2 + ")"), L0(t, l, r);
      break;
...
function iv(t, e, r, a, n) {
  M0(t, e, r, a, n), r.children && r.children.forEach((i, s) => {
    iv(t, e, i, a < 0 ? s : a, n);
  });
}
function k0(t, e) {
...
function B0(t, e) {
  e.nodes().map((r, a) => {
    const n = r.data();
    n.x = r.position().x, n.y = r.position().y, O0(t, n);
...
` + t);
  ...
  const v = await N0(o, u);
  k0(f, v), B0(s, v), xv(
    void 0,
    l,
    ((n = u.mindmap) == null ? void 0 : n.padding) ?? Cn.mindmap.padding,
    ((i = u.mindmap) == null ? void 0 : i.useMaxWidth) ?? Cn.mindmap.useMaxWidth
  );
}, _0 = {
  draw: F0
}, G0 = (t) => {
  ...
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++)
    t["lineColor" + r] = t["lineColor" + r] || t["cScaleInv" + r], mv(t["lineColor" + r]) ? t["lineColor" + r] = bv(t["lineColor" + r], 20) : t["lineColor" + r] = wv(t["lineColor" + r], 20);
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++) {
    const a = "" + (17 - 3 * r);
    e += `
