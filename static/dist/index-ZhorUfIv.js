import { ba as g, b9 as P, bu as q, bw as l, bz as i, bb as b, be as c, bg as r, bh as p } from "./vendor-BCH5z7Ar.js";
const R = 1, $ = 33, m = 34, v = 35, x = 36, W = /* @__PURE__ */ new p((O) => {
  let e = O.pos;
  for (; ; ) {
    if (O.next == 10) {
      O.advance();
...
const d = /* @__PURE__ */ n(39, $, !1), C = /* @__PURE__ */ n(34, m, !1), T = /* @__PURE__ */ n(39, v, !0), f = /* @__PURE__ */ n(34, x, !0), w = /* @__PURE__ */ b.deserialize({
  version: 14,
  ...
  tokenPrec: 0
}), A = /* @__PURE__ */ i.parser.configure({
  top: "SingleExpression"
}), Q = /* @__PURE__ */ w.configure({
  props: [
    /* @__PURE__ */ c({
      Text: r.content,
...
}), o = { parser: A }, V = { parser: i.parser }, U = /* @__PURE__ */ Q.configure({
  ...
  top: "Attribute"
}), z = { parser: U }, E = { parser: y }, s = /* @__PURE__ */ q({ selfClosingTags: !0 });
function S(O) {
  return O.configure({ wrap: l(k) }, "angular");
}
const N = /* @__PURE__ */ S(s.language);
function k(O, e) {
  switch (O.name) {
    case "Attribute":
      return /^[*#(\[]|\{\{/.test(e.read(O.from, O.to)) ? E : null;
    case "Text":
      return z;
  }
  return null;
...
function G(O = {}) {
  ...
  return new P(e.language == s.language ? N : S(e.language), [e.support, e.language.data.of({
