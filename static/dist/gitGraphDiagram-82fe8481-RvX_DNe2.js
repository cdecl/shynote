import { o as vt, p as Ct, s as Ot, a as Pt, b as Gt, c as St, g as C, l as B, d as At, u as It, q as Nt, r as Ht, k as D, t as Bt } from "./vendor-CW5mw3QE.js";
var mt = (function() {
  ...
  x.forEach((_) => {
    ...
    if (w === "TB" ? j[b.id] = { x: g, y: f } : j[b.id] = { x: f, y: k }, l) {
      if (b.type !== P.CHERRY_PICK && (b.customId && b.type === P.MERGE || b.type !== P.MERGE) && h.showCommitLabel) {
        ...
        if (A.attr("x", f - o.width / 2 - 2).attr("y", k + 13.5).attr("width", o.width + 4).attr("height", o.height + 4), w === "TB" && (A.attr("x", g - (o.width + 16 + 5)).attr("y", k - 12), S.attr("x", g - (o.width + 16)).attr("y", k + o.height - 12)), w !== "TB" && S.attr("x", f - o.width / 2), h.rotateCommitLabel)
          if (w === "TB")
