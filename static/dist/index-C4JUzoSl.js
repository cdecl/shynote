import { bb as G, bh as z, be as N, bp as I, bg as p, bt as Y, ba as j, b9 as U, bk as A, bv as Z, bc as B, bd as D, by as M } from "./vendor-BoF2JRZw.js";
...
function ge(e, t) {
  ...
  if (r && (r.to > t || r.lastChild.type.isError)) {
    ...
    return s?.name == "StartTag" ? { type: "openTag", from: t, context: b(a) } : s?.name == "StartCloseTag" && s.to <= t ? { type: "closeTag", from: t, context: a } : s?.name == "Is" ? { type: "attrValue", from: t, context: r } : s ? { type: "attrName", from: t, context: r } : null;
