import { g as gt } from "./chunk-FMBD7UC4-CE4dxHJ3.js";
import { a as mt, g as lt, h as xt, d as kt } from "./chunk-JSJVCQXG-dKYYhCTc.js";
import { aD as n, aF as _t, aE as vt, aG as bt, aH as wt, aY as Tt, aX as St, aI as R, d as X, aK as $t, b2 as Mt } from "./vendor-CW5mw3QE.js";
import { d as et } from "./arc-BrAQLIjU.js";
var U = (function() {
  var t = /* @__PURE__ */ n(function(h, i, a, l) {
    ...
    parse: /* @__PURE__ */ n(function(i) {
      var a = this, l = [0], d = [], p = [null], o = [], b = this.table, k = "", C = 0, J = 0, dt = 2, Q = 1, yt = o.slice.call(arguments, 1), _ = Object.create(this.lexer), I = { yy: {} };
...
Expecting ` + z.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : H = "Parse error on line " + (C + 1) + ": Unexpected " + (v == Q ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(H, {
        ...
        switch (T[0]) {
          case 1:
            l.push(v), p.push(_.yytext), o.push(_.yylloc), l.push(T[1]), v = null, J = _.yyleng, k = _.yytext, C = _.yylineno, Y = _.yylloc;
            break;
          case 2:
...
U.parser = U;
var Et = U, V = "", K = [], L = [], B = [], Ct = /* @__PURE__ */ n(function() {
  K.length = 0, L.length = 0, V = "", B.length = 0, Mt();
