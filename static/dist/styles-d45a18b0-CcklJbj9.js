import { bQ as G, bR as q, bS as F, bT as U, W as K, U as W, l as g, g as S, d as C, u as j, J as H, K as A, L, M as E, G as z, k as M, Y as J } from "./vendor-CW5mw3QE.js";
import { G as Q } from "./graph-U_MazhNF.js";
import { r as X } from "./index-5325376f-98fjXeHJ.js";
import { c as Y } from "./channel-CkGIa4sP.js";
function Z(e) {
  return typeof e == "string" ? new G([document.querySelectorAll(e)], [document.documentElement]) : new G([F(e)], q);
}
function be(e, l) {
...
const P = {}, re = function(e) {
  ...
  for (const b of n) {
    ...
    if (g.info("vertex", r, r.labelType), r.labelType === "markdown")
    ...
    else if (J(S().flowchart.htmlLabels))
      s = te(u, {
        label: t
      ...
      const _ = t.split(M.lineBreakRegex);
      for (const $ of _) {
  ...
  for (const n of e) {
    ...
    t.style = t.style += s, t.labelStyle = t.labelStyle += p, n.interpolate !== void 0 ? t.curve = L(n.interpolate, E) : e.defaultInterpolate !== void 0 ? t.curve = L(e.defaultInterpolate, E) : t.curve = L(P.curve, E), n.text === void 0 ? n.style !== void 0 && (t.arrowheadStyle = "fill: #333") : (t.arrowheadStyle = "fill: #333", t.labelpos = "c"), t.labelType = n.labelType, t.label = await z(
      n.text.replace(M.lineBreakRegex, `
`),
      S()
  ...
  i === void 0 && (i = "TD");
  const { securityLevel: d, flowchart: u } = S(), n = u.nodeSpacing || 50, b = u.rankSpacing || 50;
  let r;
  d === "sandbox" && (r = C("#i" + l));
  const y = d === "sandbox" ? C(r.nodes()[0].contentDocument.body) : C("body"), w = d === "sandbox" ? r.nodes()[0].contentDocument : document, t = new Q({
    multigraph: !0,
    compound: !0
  }).setGraph({
    rankdir: i,
  ...
  for (let f = p.length - 1; f >= 0; f--)
    s = p[f], g.info("Subgraph - ", s), a.db.addVertex(
      s.id,
  ...
  await R(o, t, l, y, w, a), await V(T, t);
  const _ = y.select(`[id="${l}"]`), $ = y.select("#" + l + " g");
  if (await X($, t, ["point", "circle", "cross"], "flowchart", l), j.insertTitle(_, "flowchartTitleText", u.titleTopMargin, a.db.getDiagramTitle()), H(t, _, u.diagramPadding, u.useMaxWidth), a.db.indexNodes("subGraph" + k), !u.htmlLabels) {
