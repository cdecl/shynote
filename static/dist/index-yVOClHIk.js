import { bt as u, bu as x, b9 as p, bv as h, ba as b, bw as y, bk as X, bb as Z, be as j, bc as G, bd as W, bg as n, bm as V, bh as c } from "./vendor-T05Wpcog.js";
...
const q = /* @__PURE__ */ l("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), m = /* @__PURE__ */ l("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), T = /* @__PURE__ */ l("empty forloop tablerowloop in with as", "keyword"), B = /* @__PURE__ */ l("first index index0 last length rindex", "property"), H = /* @__PURE__ */ l("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function M(O) {
  var a;
  let { state: e, pos: r } = O, $ = X(e).resolveInner(r, -1).enterUnfinishedNodesBefore(r), i = ((a = $.childBefore(r)) === null || a === void 0 ? void 0 : a.name) || $.name;
  if ($.name == "FilterName")
...
const OO = /* @__PURE__ */ u.inputHandler.of((O, a, e, r) => r != "%" || a != e || O.state.doc.sliceString(a - 1, e + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange(($) => ({
  changes: { from: $.from, to: $.to, insert: "%%" },
  range: h.cursor($.from + 1)
})), {
  scrollIntoView: !0,
  ...
  parser: /* @__PURE__ */ A.configure({
    props: [
      /* @__PURE__ */ j({
        ...
        "if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue": n.controlKeyword,
        "assign capture endcapture": n.definitionKeyword,
        contains: n.operatorKeyword,
        "render include": n.moduleKeyword,
        VariableName: n.variableName,
        TagName: n.tagName,
        FilterName: /* @__PURE__ */ n.function(n.variableName),
...
const aO = /* @__PURE__ */ f(P.language);
function iO(O = {}) {
