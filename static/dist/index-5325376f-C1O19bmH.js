import { G as A } from "./graph-vxD8NXqM.js";
import { l as H } from "./layout-CKZmpKt4.js";
import { i as N } from "./_baseUniq-2ZdiQU8D.js";
import { c as V } from "./clone-vl_Qg_aI.js";
import { m as $ } from "./_basePickBy-5vNorB-z.js";
import { i as U, u as W, s as Y, c as _, b as q, g as D, d as O, a as z, p as K, e as B, f as J, h as Q, j as Z } from "./edges-96097737-D4E386JU.js";
import { l as s, g as T, Y as S, d as L } from "./vendor-Dsy1-eqI.js";
import { a as I } from "./createText-1719965b-DUG9adZF.js";
function y(e) {
  var t = {
    options: {
...
const nt = () => {
  g = {}, R = {}, l = {};
}, p = (e, t) => (s.trace("In isDescendant", t, " ", e, " = ", g[t].includes(e)), !!g[t].includes(e)), it = (e, t) => (s.info("Descendants of ", t, " is ", g[t]), s.info("Edge is ", e), e.v === t || e.w === t ? !1 : g[t] ? g[t].includes(e.v) || p(e.v, t) || p(e.w, t) || g[t].includes(e.w) : (s.debug("Tilt, ", t, ",not in descendants"), !1)), P = (e, t, n, r) => {
  s.warn(
    "Copying children of ",
    e,
    "root",
  ...
  }), s.warn("Adjusted Graph", y(e)), F(e, 0), s.trace(l);
}, F = (e, t) => {
  if (s.warn("extractor - ", t, y(e), e.children("D")), t > 10) {
    s.error("Bailing out");
    return;
  }
  let n = e.nodes(), r = !1;
  ...
  for (const i of n)
    ...
    e.children(i) && e.children(i).length > 0) {
      ...
      s.warn("Old graph before copy", y(e)), P(i, e, u, i), e.setNode(i, {
        clusterNode: !0,
        id: i,
        clusterData: l[i].clusterData,
        labelText: l[i].labelText,
        graph: u
      }), s.warn("New graph after copy node: (", i, ")", y(u)), s.debug("Old graph after copy", y(e));
    } else
      s.warn(
        "Cluster ** ",
        i,
  ...
  return t.width = m.width, t.height = m.height, t.intersect = function(c) {
    return B(t, c);
  }, r;
}, ct = (e, t) => {
  ...
  const m = i.node().getBBox();
  return t.height = m.height, t.intersect = function(c) {
    return B(t, c);
  }, r;
}, lt = (e, t) => {
...
const dt = (e, t) => {
  ...
  s.info("Graph in recursive render: XXX", y(t), i);
  ...
  await Promise.all(
    t.nodes().map(async function(c) {
      ...
      if (s.info("(Insert) Node XXX" + c + ": " + JSON.stringify(t.node(c))), o && o.clusterNode) {
        ...
        W(o, E), o.diff = b.diff || 0, s.info("Node bounds (abc123)", c, o, o.width, o.x, o.y), Y(E, o), s.warn("Recursive render complete ", E, o);
      } else
  ...
  }), s.info("#############################################"), s.info("###                Layout                 ###"), s.info("#############################################"), s.info(t), H(t), s.info("Graph after layout:", y(t));
  let v = 0;
  const { subGraphTitleTotalMargin: m } = D(a);
  return rt(t).forEach(function(c) {
    ...
    s.info("Position " + c + ": " + JSON.stringify(t.node(c))), s.info(
      ...
      " height: ",
      o.height
    ), o && o.clusterNode ? (o.y += m, O(o)) : t.children(c).length > 0 ? (o.height += m, dt(f, o), l[o.id].node = o) : (o.y += m / 2, O(o));
  }), t.edges().forEach(function(c) {
    const o = t.edge(c);
    s.info("Edge " + c.v + " -> " + c.w + ": " + JSON.stringify(o), o), o.points.forEach((E) => E.y += m / 2);
    const b = z(h, c, o, l, n, t, r);
    K(o, b);
  ...
  U(e, n, r, i), Q(), Z(), ut(), nt(), s.warn("Graph at first:", JSON.stringify(y(t))), st(t), s.warn("Graph after:", JSON.stringify(y(t)));
  const a = T();
