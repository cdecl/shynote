import { l as g, D as lt, H as ct, g as b, Y as H, d as E, u as j, i as Q, _ as V } from "./vendor-Dsy1-eqI.js";
import { a as st } from "./createText-1719965b-DUG9adZF.js";
const ht = (a, t, e, i) => {
  t.forEach((l) => {
    wt[l](a, e, i);
  });
...
const dr = (a, t) => {
  ...
  const { x: p, y: d } = rr(e), k = lt().x(p).y(d).curve(f);
  let x;
  switch (e.thickness) {
    case "normal":
