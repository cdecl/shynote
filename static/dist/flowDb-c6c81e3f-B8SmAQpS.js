...
var pt = (function() {
  var e = function(f1, a, o, f) {
    ...
    performAction: function(a, o, f, r, S, t, N1) {
      var s = t.length - 1;
      switch (S) {
        case 2:
          this.$ = [];
    ...
    parse: function(a) {
      var o = this, f = [0], r = [], S = [null], t = [], N1 = this.table, s = "", Y = 0, Yt = 0, Ce = 2, jt = 1, _e = t.slice.call(arguments, 1), _ = Object.create(this.lexer), d1 = { yy: {} };
      ...
      for (var G, E1, j, ht, v1 = {}, q1, n1, zt, Q1; ; ) {
        if (E1 = f[f.length - 1], this.defaultActions[E1] ? j = this.defaultActions[E1] : ((G === null || typeof G > "u") && (G = Be()), j = N1[E1] && N1[E1][G]), typeof j > "u" || !j.length || !j[0]) {
          ...
          Q1 = [];
          for (q1 in N1[E1])
            this.terminals_[q1] && q1 > Ce && Q1.push("'" + this.terminals_[q1] + "'");
...
Expecting ` + Q1.join(", ") + ", got '" + (this.terminals_[G] || G) + "'" : ft = "Parse error on line " + (Y + 1) + ": Unexpected " + (G == jt ? "end of input" : "'" + (this.terminals_[G] || G) + "'"), this.parseError(ft, {
        ...
        switch (j[0]) {
          case 1:
            ...
            break;
          case 2:
            if (n1 = this.productions_[j[1]][1], v1.$ = S[S.length - n1], v1._$ = {
              ...
              return ht;
            n1 && (f = f.slice(0, -1 * n1 * 2), S = S.slice(0, -1 * n1), t = t.slice(0, -1 * n1)), f.push(this.productions_[j[1]][0]), S.push(v1.$), t.push(v1._$), zt = N1[f[f.length - 2]][f[f.length - 1]], f.push(zt);
            break;
          case 3:
            return !0;
        }
...
` + o + "^";
      ...
      test_match: function(a, o) {
        ...
        }, this.options.ranges && (S.yylloc.range = this.yylloc.range.slice(0))), r = a[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
      ...
      next: function() {
        ...
        return o ? (a = this.test_match(o, S[r]), a !== !1 ? a : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
