import { P as ro, Q as yv, l as Nr, as as mv, at as bv, au as wv, g as ao, U as Ev, o as xv, Y as En, i as xn, d as Tv, X as Cv } from "./vendor-T05Wpcog.js";
import { a as Dv } from "./createText-1719965b-DYaAbb2m.js";
function Ns(t, e) {
...
}, at = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", $v = "rgb[a]?\\((" + at + "[%]?)\\s*,\\s*(" + at + "[%]?)\\s*,\\s*(" + at + "[%]?)(?:\\s*,\\s*(" + at + "))?\\)", Yv = "rgb[a]?\\((?:" + at + "[%]?)\\s*,\\s*(?:" + at + "[%]?)\\s*,\\s*(?:" + at + "[%]?)(?:\\s*,\\s*(?:" + at + "))?\\)", Hv = "hsl[a]?\\((" + at + ")\\s*,\\s*(" + at + "[%])\\s*,\\s*(" + at + "[%])(?:\\s*,\\s*(" + at + "))?\\)", Xv = "hsl[a]?\\((?:" + at + ")\\s*,\\s*(?:" + at + "[%])\\s*,\\s*(?:" + at + "[%])(?:\\s*,\\s*(?:" + at + "))?\\)", Wv = "\\#[0-9a-fA-F]{3}", Kv = "\\#[0-9a-fA-F]{6}", mf = function(e, r) {
...
var $g = qg(), Yg = /* @__PURE__ */ _a($g), bs, gl;
function Hg() {
  if (gl) return bs;
  gl = 1;
  function t(e, r) {
    ...
    if (a && a.isNode())
      if (u)
        for (var l = 0; l < this.length; l++) {
          var f = this[l];
          r !== void 0 ? f.position(e, (r - s[e]) / i) : o !== void 0 && f.position(If(o, i, s));
        }
      else {
        var c = a.position();
...
[Vf, Jg, hn, ur, aa, dp, Hn, Pp, vc, hc, Np, Pn, dn, ct, lr, pt].forEach(function(t) {
  be(qe, t);
});
var Up = {
  add: function(e) {
...
var Hs, Xs, Vt = {}, Pt = {}, zl, Vl, Lr, mn, Wt, Tr, Sr, Gt, qr, on, Ac, Lc, Ws, Ks, Ul, ql = function(e, r, a) {
...
$t.recalculateEdgeLabelProjections = function(t) {
  ...
  if (i.mid || i.source || i.target) {
    ...
    var o = Ic(a.midDispX, a.midDispY);
  ...
  t.registerBinding(e, "touchmove", we = function(I) {
    ...
    if (!(!U && !D(I))) {
      ...
      if (U && t.touchData.cxt) {
        ...
        if (re) {
          var uv = Ke - G, lv = st - Y, fv = et - $, cv = ft - H, vv = (uv + fv) / 2, hv = (lv + cv) / 2, ca = K.zoom(), ti = ca * ov, Ka = K.pan(), Mo = J[0] * ca + Ka.x, Oo = J[1] * ca + Ka.y, dv = {
...
}(), Xl = 25, un = 50, bn = -4, Zs = 3, _c = 7.99, Iy = 8, My = 1024, Oy = 1024, ky = 1024, Ny = 0.2, By = 0.8, Fy = 10, _y = 0.15, Gy = 0.1, zy = 0.9, Vy = 0.9, Uy = 100, qy = 1, Zr = {
  dequeue: "dequeue",
  downscale: "downscale",
...
var Yy = 1, Ca = -4, kn = 2, Hy = 3.99, Xy = 50, Wy = 50, Ky = 0.15, Zy = 0.1, Qy = 0.9, Jy = 0.9, jy = 1, Wl = 250, em = 4e3 * 4e3, Kl = 32767, tm = !0, Gc = function(e) {
...
wr.drawNode = function(t, e, r) {
  ...
  if (!(!ne(c.x) || !ne(c.y)) && !(i && !e.visible())) {
    ...
    var ae = function() {
      ...
      var X = s.nodePathCache = s.nodePathCache || [], K = Sf(I === "polygon" ? I + "," + U.join(",") : I, "" + Q, "" + ue, "" + ee), j = X[K], oe, te = !1;
...
}, Ls = 0, nf = 1, sf = 2, Rs = 3, Yr = 4, ln = 5, ma = 6, ba = 7, Fm = /* @__PURE__ */ function() {
  function t(e, r, a) {
...
Yc.initWebgl = function(t, e) {
  ...
  r.drawing.addAtlasCollection("node", {
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ps(e.getLabelKey, null),
    getBoundingBox: Is(e.getLabelBox, null),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ps(e.getSourceLabelKey, "source"),
    getBoundingBox: Is(e.getSourceLabelBox, "source"),
    drawClipped: !0,
    ...
    collection: "label",
    getTexPickingMode: o,
    getKey: Ps(e.getTargetLabelKey, "target"),
    getBoundingBox: Is(e.getTargetLabelBox, "target"),
    drawClipped: !0,
...
for (var Hr = 0 * Math.PI; Hr < 2 * Math.PI; Hr += Kc)
  Js[Hr] = Math.sin(Hr), js[Hr] = Math.cos(Hr);
