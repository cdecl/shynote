import { g as le } from "./chunk-55IACEB6-B5hbWQVG.js";
import { s as he } from "./chunk-KX2RTZJC-DbMRxAwL.js";
import { aD as l, aJ as I, aU as de, aV as ge, b8 as B, aI as X, aN as V, bX as ue, Q as pe, R as fe, S as ye } from "./vendor-Dsy1-eqI.js";
const E = [];
for (let t = 0; t < 256; ++t)
...
var W = (function() {
  var t = /* @__PURE__ */ l(function(x, s, i, a) {
    for (i = i || {}, a = x.length; a--; i[x[a]] = s) ;
    return i;
  }, "o"), e = [1, 4], n = [1, 13], c = [1, 12], f = [1, 15], h = [1, 16], p = [1, 20], m = [1, 19], u = [6, 7, 8], D = [1, 26], Y = [1, 24], J = [1, 25], b = [6, 7, 11], Q = [1, 6, 13, 15, 16, 19, 22], q = [1, 33], K = [1, 34], R = [1, 6, 7, 11, 13, 15, 16, 19, 22], F = {
    ...
    performAction: /* @__PURE__ */ l(function(s, i, a, o, g, r, w) {
      var d = r.length - 1;
      switch (g) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: n, 7: [1, 10], 9: 9, 12: 11, 13: c, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m }, t(u, [2, 3]), { 1: [2, 2] }, t(u, [2, 4]), t(u, [2, 5]), { 1: [2, 6], 6: n, 12: 21, 13: c, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m }, { 6: n, 9: 22, 12: 11, 13: c, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m }, { 6: D, 7: Y, 10: 23, 11: J }, t(b, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: m }), t(b, [2, 18]), t(b, [2, 19]), t(b, [2, 20]), t(b, [2, 21]), t(b, [2, 23]), t(b, [2, 24]), t(b, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: D, 7: Y, 10: 32, 11: J }, { 1: [2, 7], 6: n, 12: 21, 13: c, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m }, t(Q, [2, 14], { 7: q, 11: K }), t(R, [2, 8]), t(R, [2, 9]), t(R, [2, 10]), t(b, [2, 15]), t(b, [2, 16]), t(b, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, t(Q, [2, 13], { 7: q, 11: K }), t(R, [2, 11]), t(R, [2, 12]), { 21: [1, 37] }, t(b, [2, 25]), t(b, [2, 27])],
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, a = [0], o = [], g = [null], r = [], w = this.table, d = "", U = 0, Z = 0, re = 2, ee = 1, ae = r.slice.call(arguments, 1), y = Object.create(this.lexer), v = { yy: {} };
      ...
      function ce(S) {
        a.length = a.length - 2 * S, g.length = g.length - S, r.length = r.length - S;
      }
      l(ce, "popStack");
      function te() {
        var S;
        return S = o.pop() || y.lex() || ee, typeof S != "number" && (S instanceof Array && (o = S, S = o.pop()), S = i.symbols_[S] || S), S;
      }
      l(te, "lex");
      for (var _, T, N, H, O = {}, P, k, ie, M; ; ) {
        if (T = a[a.length - 1], this.defaultActions[T] ? N = this.defaultActions[T] : ((_ === null || typeof _ > "u") && (_ = te()), N = w[T] && w[T][_]), typeof N > "u" || !N.length || !N[0]) {
          var $ = "";
          M = [];
          for (P in w[T])
...
Expecting ` + M.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : $ = "Parse error on line " + (U + 1) + ": Unexpected " + (_ == ee ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError($, {
        ...
        switch (N[0]) {
          case 1:
            a.push(_), g.push(y.yytext), r.push(y.yylloc), a.push(N[1]), _ = null, Z = y.yyleng, d = y.yytext, U = y.yylineno, G = y.yylloc;
            break;
          case 2:
            if (k = this.productions_[N[1]][1], O.$ = g[g.length - k], O._$ = {
              ...
              g,
              r
            ].concat(ae)), typeof H < "u")
              return H;
            k && (a = a.slice(0, -1 * k * 2), g = g.slice(0, -1 * k), r = r.slice(0, -1 * k)), a.push(this.productions_[N[1]][0]), g.push(O.$), r.push(O._$), ie = w[a[a.length - 2]][a[a.length - 1]], a.push(ie);
            break;
          case 3:
            return !0;
        }
...
var Ne = W, De = 12, L = {
   ...
   */
  getData() {
    const e = this.getMindmap(), n = X(), f = ue().layout !== void 0, h = n;
