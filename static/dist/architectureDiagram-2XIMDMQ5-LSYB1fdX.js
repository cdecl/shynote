import { bW as Ze, aD as dt, ba as ke, bl as qe, aJ as Se, aH as Qe, aG as Je, aX as Ke, aY as je, aF as _e, aE as tr, b2 as er, b6 as rr, b7 as ir, b8 as ar, aI as Ee, bs as me, bY as pe, aN as nr, d as or, b0 as sr, bZ as hr, b_ as lr } from "./vendor-CW5mw3QE.js";
import { p as fr } from "./chunk-4BX2VUAB-akHX38MJ.js";
import { p as cr } from "./treemap-KZPCXAKY-C0qkw44J.js";
import { c as Fe } from "./cytoscape.esm-Cvf3sx9F.js";
var he = { exports: {} }, le = { exports: {} }, fe = { exports: {} }, gr = fe.exports, Me;
function ur() {
  return Me || (Me = 1, (function(I, D) {
    (function(P, N) {
      I.exports = N();
    })(gr, function() {
      return (
        ...
        (function(C) {
          ...
          return N.m = C, N.c = P, N.i = function(u) {
            return u;
          }, N.d = function(u, h, a) {
          ...
          (function(C, P, N) {
            ...
            o.prototype.getNodes = function() {
              ...
              if (c instanceof r) {
                ...
                var A = d.source.edges.indexOf(d), G = d.target.edges.indexOf(d);
                if (!(A > -1 && G > -1))
                  throw "Source and/or target doesn't know this edge!";
                d.source.edges.splice(A, 1), d.target != d.source && d.target.edges.splice(G, 1);
              ...
              for (var c = h.MAX_VALUE, f = h.MAX_VALUE, T, d, v, L = this.getNodes(), b = L.length, A = 0; A < b; A++) {
                var G = L[A];
              ...
              for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, d = h.MAX_VALUE, v = -h.MAX_VALUE, L, b, A, G, k, Y = this.nodes, K = Y.length, O = 0; O < K; O++) {
                var it = Y[O];
                c && it.child != null && it.updateBounds(), L = it.getLeft(), b = it.getRight(), A = it.getTop(), G = it.getBottom(), f > L && (f = L), T < b && (T = b), d > A && (d = A), v < G && (v = G);
              }
              ...
              for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, d = h.MAX_VALUE, v = -h.MAX_VALUE, L, b, A, G, k = c.length, Y = 0; Y < k; Y++) {
                var K = c[Y];
                L = K.getLeft(), b = K.getRight(), A = K.getTop(), G = K.getBottom(), f > L && (f = L), T < b && (T = b), d > A && (d = A), v < G && (v = G);
              }
          ...
          (function(C, P, N) {
            ...
            h.calcSeparationAmount = function(a, e, r, l) {
              ...
              var o = a.getX(), s = a.getY(), c = a.getRight(), f = a.getX(), T = a.getBottom(), d = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), b = e.getX(), A = e.getY(), G = e.getRight(), k = e.getX(), Y = e.getBottom(), K = e.getRight(), O = e.getWidthHalf(), it = e.getHeightHalf(), n = !1, m = !1;
              if (l === g) {
                if (i > t)
                  return r[0] = l, r[1] = s, r[2] = g, r[3] = Y, !1;
                if (i < t)
                  return r[0] = l, r[1] = T, r[2] = g, r[3] = A, !1;
              } else if (i === t) {
                if (l > g)
                ...
                var p = a.height / a.width, E = e.height / e.width, y = (t - i) / (g - l), R = void 0, w = void 0, S = void 0, W = void 0, x = void 0, q = void 0;
                if (-p === y ? l > g ? (r[0] = f, r[1] = T, n = !0) : (r[0] = c, r[1] = s, n = !0) : p === y && (l > g ? (r[0] = o, r[1] = s, n = !0) : (r[0] = d, r[1] = T, n = !0)), -E === y ? g > l ? (r[2] = k, r[3] = Y, m = !0) : (r[2] = G, r[3] = A, m = !0) : E === y && (g > l ? (r[2] = b, r[3] = A, m = !0) : (r[2] = K, r[3] = Y, m = !0)), n && m)
                  return !1;
                if (l > g ? i > t ? (R = this.getCardinalDirection(p, y, 4), w = this.getCardinalDirection(E, y, 2)) : (R = this.getCardinalDirection(-p, y, 3), w = this.getCardinalDirection(-E, y, 1)) : i > t ? (R = this.getCardinalDirection(-p, y, 1), w = this.getCardinalDirection(-E, y, 3)) : (R = this.getCardinalDirection(p, y, 2), w = this.getCardinalDirection(E, y, 4)), !n)
                  switch (R) {
                    case 1:
              ...
              var i = a.x, g = a.y, t = e.x, o = e.y, s = r.x, c = r.y, f = l.x, T = l.y, d = void 0, v = void 0, L = void 0, b = void 0, A = void 0, G = void 0, k = void 0, Y = void 0, K = void 0;
              return L = o - g, A = i - t, k = t * g - i * o, b = T - c, G = s - f, Y = f * c - s * T, K = L * G - b * A, K === 0 ? null : (d = (A * Y - G * k) / K, v = (b * k - L * Y) / K, new u(d, v));
            ...
            }, h.HALF_PI = 0.5 * Math.PI, h.ONE_AND_HALF_PI = 1.5 * Math.PI, h.TWO_PI = 2 * Math.PI, h.THREE_PI = 3 * Math.PI, C.exports = h;
          }),
          /* 9 */
          /***/
          (function(C, P, N) {
          ...
          (function(C, P, N) {
            ...
            o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
              ...
              if (!T)
                return s;
              var v = /* @__PURE__ */ new Set(), L = [], b = /* @__PURE__ */ new Map(), A = [];
              ...
              if (f != null && T != null) {
                ...
                var b, A;
                return s <= 50 ? (b = 9 * c / 500, A = c / 10) : (b = 9 * c / 50, A = -8 * c), b * s + A;
              }
              ...
              for (var L = 0; L < c.length; L++) {
                var b = c[L], A = b.getNeighborsList().size;
          ...
          (function(C, P, N) {
            ...
            i.prototype.initParameters = function() {
              ...
              var s = t.getRect(), c = o.getRect(), f = new Array(2), T = new Array(4), d, v, L, b, A, G, k;
              if (s.intersects(c)) {
                ...
                this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null ? (d = c.getCenterX() - s.getCenterX(), v = c.getCenterY() - s.getCenterY()) : (r.getIntersection(s, c, T), d = T[2] - T[0], v = T[3] - T[1]), Math.abs(d) < a.MIN_REPULSION_DIST && (d = l.sign(d) * a.MIN_REPULSION_DIST), Math.abs(v) < a.MIN_REPULSION_DIST && (v = l.sign(v) * a.MIN_REPULSION_DIST), L = d * d + v * v, b = Math.sqrt(L), A = (t.nodeRepulsion / 2 + o.nodeRepulsion / 2) * t.noOfChildren * o.noOfChildren / L, G = A * d / b, k = A * v / b, t.repulsionForceX -= G, t.repulsionForceY -= k, o.repulsionForceX += G, o.repulsionForceY += k;
        ...
        (() => {
          var P = {
            ...
            765: (
              /***/
              ((a, e, r) => {
                var l = r(551).FDLayout, i = r(578), g = r(880), t = r(991), o = r(767), s = r(806), c = r(902), f = r(551).FDLayoutConstants, T = r(551).LayoutConstants, d = r(551).Point, v = r(551).PointD, L = r(551).DimensionD, b = r(551).Layout, A = r(551).Integer, G = r(551).IGeometry, k = r(551).LGraph, Y = r(551).Transform, K = r(551).LinkedList;
                function O() {
                ...
                O.prototype.newGraphManager = function() {
                  ...
                  for (var m = new d(0, 0), p = Math.ceil(Math.sqrt(n.length)), E = 0, y = 0, R = 0, w = new v(0, 0), S = 0; S < n.length; S++) {
                    S % p == 0 && (R = 0, y = E, S != 0 && (y += s.DEFAULT_COMPONENT_SEPERATION), E = 0);
                    var W = n[S], x = b.findCenterOfTree(W);
                    m.x = R, m.y = y, w = O.radialLayout(W, x, m), w.y > E && (E = Math.floor(w.y)), R = Math.floor(w.x + s.DEFAULT_COMPONENT_SEPERATION);
                  }
                  ...
                  var p = s.TILING_PADDING_VERTICAL, E = s.TILING_PADDING_HORIZONTAL, y = n.length, R = 0, w = 0, S = 0;
                  n.forEach(function(z) {
                    R += z.getWidth(), w += z.getHeight(), z.getWidth() > S && (S = z.getWidth());
                  });
                  var W = R / y, x = w / y, q = Math.pow(p - E, 2) + 4 * (W + E) * (x + p) * y, V = (E - p + Math.sqrt(q)) / (2 * (W + E)), X;
                  ...
                  if (E == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL)
                    ...
                    var y = p.startX, R = p.finishX, w = p.startY, S = p.finishY, W = 0, x = 0, q = 0, V = 0, X = [W, q, x, V];
                    if (w > 0)
            ...
            902: (
              ...
              ((a, e, r) => {
                ...
                s.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), v = [], L = [], b = c.getAllNodes(), A = 0, G = 0; G < b.length; G++) {
                    var k = b[G];
                    k.getChild() == null && (d.set(k.id, A++), v.push(k.getCenterX()), L.push(k.getCenterY()), T.set(k.id, k));
                  }
                  ...
                  if (f.fixedNodeConstraint && f.fixedNodeConstraint.forEach(function(F) {
                    ...
                    if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1)
                      ...
                      (function() {
                        ...
                        if (f.alignmentConstraint.vertical) {
                          for (var U = f.alignmentConstraint.vertical, B = function(tt) {
                            ...
                            ut.size > 0 ? wt = v[d.get(ut.values().next().value)] : wt = K(j).x, U[tt].forEach(function(pt) {
                              E[F] = [wt, L[d.get(pt)]], y[F] = [v[d.get(pt)], L[d.get(pt)]], F++;
                            });
                          }, J = 0; J < U.length; J++)
                            B(J);
                          R = !0;
                        ...
                        if (f.alignmentConstraint.horizontal) {
                          for (var Z = f.alignmentConstraint.horizontal, at = function(tt) {
                            ...
                            ut.size > 0 ? wt = v[d.get(ut.values().next().value)] : wt = K(j).y, Z[tt].forEach(function(pt) {
                              E[F] = [v[d.get(pt)], wt], y[F] = [v[d.get(pt)], L[d.get(pt)]], F++;
                            });
                          }, ct = 0; ct < Z.length; ct++)
                            at(ct);
                          R = !0;
                      ...
                      if (V < x.size / 2)
                        it(f.relativePlacementConstraint), R = !1, w = !1;
                      else {
                        var z = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), H = [];
                        q[X].forEach(function(F) {
                          W.get(F).forEach(function(U) {
                            U.direction == "horizontal" ? (z.has(F) ? z.get(F).push(U) : z.set(F, [U]), z.has(U.id) || z.set(U.id, []), H.push({ left: F, right: U.id })) : (M.has(F) ? M.get(F).push(U) : M.set(F, [U]), M.has(U.id) || M.set(U.id, []), H.push({ top: F, bottom: U.id }));
                          });
                        }), it(H), w = !1;
                        var $ = O(z, "horizontal"), _ = O(M, "vertical");
                    ...
                    f.relativePlacementConstraint && (function() {
                      ...
                      if (S.forEach(function(Gt) {
                        ...
                        if (f.alignmentConstraint.vertical)
                          for (var tt = f.alignmentConstraint.vertical, j = function(yt) {
                            ...
                            j(ut);
                        if (f.alignmentConstraint.horizontal)
                          for (var wt = f.alignmentConstraint.horizontal, pt = function(yt) {
                      ...
                      var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt) {
                        W.get(yt).forEach(function(Mt) {
                          ...
                          Mt.direction == "horizontal" ? (kt = F.get(yt) ? F.get(yt) : yt, F.get(Mt.id) ? Bt = { id: F.get(Mt.id), gap: Mt.gap, direction: Mt.direction } : Bt = Mt, lt.has(kt) ? lt.get(kt).push(Bt) : lt.set(kt, [Bt]), lt.has(Bt.id) || lt.set(Bt.id, [])) : (kt = U.get(yt) ? U.get(yt) : yt, U.get(Mt.id) ? Bt = { id: U.get(Mt.id), gap: Mt.gap, direction: Mt.direction } : Bt = Mt, ot.has(kt) ? ot.get(kt).push(Bt) : ot.set(kt, [Bt]), ot.has(Bt.id) || ot.set(Bt.id, []));
                        });
                      }, ft = !0, st = !1, Xt = void 0;
                      try {
            ...
            548: (
              ...
              ((a, e, r) => {
                ...
                g.getTopMostNodes = function(t) {
                  ...
                  var f = new i(), T = /* @__PURE__ */ new Set(), d = [], v = void 0, L = void 0, b = void 0, A = !1, G = 1, k = [], Y = [], K = function() {
                    var it = t.collection();
                    Y.push(it);
                  ...
                  if (!s.fixedNodeConstraint) {
                    ...
                    if (s.quality == "draft") {
                      ...
                      try {
                        for (var A = o.nodeIndexes[Symbol.iterator](), G; !(v = (G = A.next()).done); v = !0) {
                  ...
                  for (var f = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, d = Number.MAX_SAFE_INTEGER, v = Number.MIN_SAFE_INTEGER, L = void 0, b = void 0, A = void 0, G = void 0, k = t.descendants().not(":parent"), Y = k.length, K = 0; K < Y; K++) {
                    var O = k[K];
                    L = o[c.get(O.id())] - O.width() / 2, b = o[c.get(O.id())] + O.width() / 2, A = s[c.get(O.id())] - O.height() / 2, G = s[c.get(O.id())] + O.height() / 2, f > L && (f = L), T < b && (T = b), d > A && (d = A), v < G && (v = G);
                  }
                  var it = {};
            ...
            816: (
              ...
              ((a, e, r) => {
                var l = r(548), i = r(140).CoSELayout, g = r(140).CoSENode, t = r(140).layoutBase.PointD, o = r(140).layoutBase.DimensionD, s = r(140).layoutBase.LayoutConstants, c = r(140).layoutBase.FDLayoutConstants, f = r(140).CoSEConstants, T = function(v, L) {
                  var b = v.cy, A = v.eles, G = A.nodes(), k = A.edges(), Y = void 0, K = void 0, O = void 0, it = {};
                  v.randomize && (Y = L.nodeIndexes, K = L.xCoords, O = L.yCoords);
                  var n = function(x) {
                    return typeof x == "function";
                  }, m = function(x, q) {
                    return n(x) ? x(q) : x;
                  }, p = l.calcParentsWithoutChildren(b, A), E = function W(x, q, V, X) {
                    for (var et = q.length, z = 0; z < et; z++) {
                      ...
                      if (M.outerWidth() != null && M.outerHeight() != null)
                        if (X.randomize)
                          if (!M.isParent())
                            $ = x.add(new g(V.graphManager, new t(K[Y.get(M.id())] - _.w / 2, O[Y.get(M.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                          else {
                      ...
                      if ($.id = M.data("id"), $.nodeRepulsion = m(X.nodeRepulsion, M), $.paddingLeft = parseInt(M.css("padding")), $.paddingTop = parseInt(M.css("padding")), $.paddingRight = parseInt(M.css("padding")), $.paddingBottom = parseInt(M.css("padding")), X.nodeDimensionsIncludeLabels && ($.labelWidth = M.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).w, $.labelHeight = M.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).h, $.labelPosVertical = M.css("text-valign"), $.labelPosHorizontal = M.css("text-halign")), it[M.data("id")] = $, isNaN($.rect.x) && ($.rect.x = 0), isNaN($.rect.y) && ($.rect.y = 0), H != null && H.length > 0) {
                        var Q = void 0;
                    ...
                    for (var X = 0, et = 0, z = 0; z < V.length; z++) {
                      var M = V[z], H = it[M.data("source")], $ = it[M.data("target")];
                      if (H && $ && H !== $ && H.getEdgesBetween($).length == 0) {
                        var _ = q.add(x.newEdge(), H, $);
                        _.id = M.id(), _.idealLength = m(v.idealEdgeLength, M), _.edgeElasticity = m(v.edgeElasticity, M), X += _.idealLength, et++;
                      }
                    }
                  ...
                  return E(S.addRoot(), l.getTopMostNodes(G), w, v), y(w, S, k), R(w, v), w.runLayout(), it;
                };
              ...
              ((a, e, r) => {
                ...
                var g = r(658), t = r(548), o = r(657), s = o.spectralLayout, c = r(816), f = c.coseLayout, T = Object.freeze({
                  ...
                  return l(v, [{
                    key: "run",
                    value: function() {
                      var b = this, A = this.options, G = A.cy, k = A.eles, Y = [], K = [], O = void 0, it = [];
                      ...
                      var m = void 0, p = !1;
                      if (G.layoutUtilities && A.packComponents && (m = G.layoutUtilities("get"), m || (m = G.layoutUtilities()), p = !0), k.nodes().length > 0)
                        if (p) {
                          var R = t.getTopMostNodes(A.eles.nodes());
                          if (O = t.connectComponents(G, A.eles, R), O.forEach(function(vt) {
                            var rt = vt.boundingBox();
                            it.push({ x: rt.x1 + rt.w / 2, y: rt.y1 + rt.h / 2 });
                          }), A.randomize && O.forEach(function(vt) {
                            ...
                            if (A.tile) {
                              ...
                              if (O.forEach(function(vt, rt) {
                                ...
                                it.push({ x: et.x1 + et.w / 2, y: et.y1 + et.h / 2 }), O.push(w), Y.push(V);
                                for (var z = X.length - 1; z >= 0; z--)
                                  O.splice(X[z], 1), Y.splice(X[z], 1), it.splice(X[z], 1);
                              }
                            }
                            O.forEach(function(vt, rt) {
                              A.eles = vt, K.push(f(A, Y[rt])), t.relocateComponent(it[rt], K[rt], A);
                            });
                          } else
                            O.forEach(function(vt, rt) {
                          ...
                          if (O.length > 1) {
                            ...
                            O.forEach(function(vt, rt) {
                              var gt = void 0;
                              if (A.quality == "draft" && (gt = Y[rt].nodeIndexes), vt.nodes().not($).length > 0) {
                                var mt = {};
                                mt.edges = [], mt.nodes = [];
                                var At = void 0;
                          ...
                          A.quality == "default" || A.quality == "proof" ? (K.push(f(A, Y[0])), t.relocateComponent(it[0], K[0], A)) : t.relocateComponent(it[0], Y[0], A);
                        }
                      ...
                      if (A.quality == "default" || A.quality == "proof" || A.randomize) {
                        ...
                        A.eles = k.not(Nt), k.nodes().not(":parent").not(Nt).layoutPositions(b, A, Q), It.length > 0 && It.forEach(function(vt) {
                          vt.position(Q(vt));
                        });
                      } else
            ...
            657: (
              ...
              ((a, e, r) => {
                var l = r(548), i = r(140).layoutBase.Matrix, g = r(140).layoutBase.SVD, t = function(s) {
                  var c = s.cy, f = s.eles, T = f.nodes(), d = f.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), A = [], G = [], k = [], Y = [], K = [], O = [], it = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, R = s.samplingType, w = s.nodeSeparation, S = void 0, W = function() {
                  ...
                  d.forEach(function(F) {
                    ...
                    F.isParent() ? U = L.get(b.get(F.id())) : U = L.get(F.id()), F.neighborhood().nodes().forEach(function(B) {
                      f.intersection(F.edgesWith(B)).length > 0 && (B.isParent() ? A[U].push(b.get(B.id())) : A[U].push(B.id()));
                    });
                  });
                  var Nt = function(U) {
                    var B = L.get(U), J = void 0;
                    v.get(U).forEach(function(Z) {
                      c.getElementById(Z).isParent() ? J = b.get(Z) : J = Z, A[B].push(J), A[L.get(J)].push(U);
                    });
                  }, vt = !0, rt = !1, gt = void 0;
                  try {
...
var xe = {
  ...
  const C = Wt(I) && qt(D), P = qt(I) && Wt(D);
  return C || P;
}, "isArchitectureDirectionXY"), Nr = /* @__PURE__ */ dt(function(I) {
  const D = I[0], C = I[1], P = Wt(D) && qt(C), N = qt(D) && Wt(C);
  return P || N;
...
}, "getArchitectureDirectionPair"), Cr = /* @__PURE__ */ dt(function([I, D], C) {
  const P = C[0], N = C[1];
...
}, "getArchitectureDirectionXYFactors"), wr = /* @__PURE__ */ dt(function(I, D) {
  ...
  addJunction({ id: D, in: C }) {
    ...
    if (C !== void 0) {
      if (D === C)
        throw new Error(`The junction [${D}] cannot be placed within itself`);
  ...
  addEdge({
    ...
    const l = this.nodes[D].in, i = this.nodes[C].in;
    if (a && l && i && l == i)
      throw new Error(
    ...
    this.edges.push(g), this.nodes[D] && this.nodes[C] && (this.nodes[D].edges.push(this.edges[this.edges.length - 1]), this.nodes[C].edges.push(this.edges[this.edges.length - 1]));
  }
  getEdges() {
    return this.edges;
  }
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const D = {}, C = Object.entries(this.nodes).reduce((e, [r, l]) => (e[r] = l.edges.reduce((i, g) => {
        ...
        return i;
      }, {}), e), {}), P = Object.keys(C)[0], N = { [P]: 1 }, u = Object.keys(C).reduce(
        (e, r) => r === P ? e : { ...e, [r]: 1 },
        {}
      ), h = /* @__PURE__ */ dt((e) => {
        const r = { [e]: [0, 0] }, l = [e];
  ...
  fr(I, D), I.groups.map((C) => D.addGroup(C)), I.services.map((C) => D.addService({ ...C, type: "service" })), I.junctions.map((C) => D.addJunction({ ...C, type: "junction" })), I.edges.map((C) => D.addEdge(C));
}, "populateDb"), Ge = {
  parser: {
...
`, "getStyles"), Rr = Ir, re = /* @__PURE__ */ dt((I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`, "wrapIcon"), ne = {
...
}, Sr = /* @__PURE__ */ dt(async function(I, D, C) {
  const P = C.getConfigField("padding"), N = C.getConfigField("iconSize"), u = N / 2, h = N / 6, a = h / 2;
  await Promise.all(
    D.edges().map(async (e) => {
      const {
        source: r,
      ...
      const G = P + 4;
      if (g && (Wt(l) ? T += l === "L" ? -G : G : d += l === "T" ? -G : G + 18), c && (Wt(o) ? b += o === "L" ? -G : G : A += o === "T" ? -G : G + 18), !g && C.getNode(r)?.type === "junction" && (Wt(l) ? T += l === "L" ? u : -u : d += l === "T" ? u : -u), !c && C.getNode(t)?.type === "junction" && (Wt(o) ? b += o === "L" ? u : -u : A += o === "T" ? u : -u), e[0]._private.rscratch) {
        const k = I.insert("g");
        if (k.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${b},${A} `).attr("class", "edge").attr("id", sr(r, t, { prefix: "L" })), i) {
...
}, "drawEdges"), Fr = /* @__PURE__ */ dt(async function(I, D, C) {
  const N = C.getConfigField("padding") * 0.75, u = C.getConfigField("fontSize"), a = C.getConfigField("iconSize") / 2;
  await Promise.all(
    D.nodes().map(async (e) => {
      const r = ie(e);
      if (r.type === "group") {
...
}, "drawGroups"), br = /* @__PURE__ */ dt(async function(I, D, C) {
  const P = Ee();
  for (const N of C) {
  ...
  return 0;
}, "drawServices"), Pr = /* @__PURE__ */ dt(function(I, D, C) {
  C.forEach((P) => {
...
function Xe(I, D) {
  D.nodes().map((C) => {
    ...
    if (P.type === "group")
      return;
    P.x = C.position().x, P.y = C.position().y, I.getElementById(P.id).attr("transform", "translate(" + (P.x || 0) + "," + (P.y || 0) + ")");
  });
}
dt(Xe, "positionNodes");
function He(I, D) {
...
function We(I, D) {
  I.forEach((C) => {
    const { lhsId: P, rhsId: N, lhsInto: u, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: r, rhsGroup: l, title: i } = C, g = Te(C.lhsDir, C.rhsDir) ? "segments" : "straight", t = {
      id: `${P}-${N}`,
      label: i,
      source: P,
      sourceDir: e,
...
dt(Ve, "getAlignments");
function ze(I, D) {
  const C = [], P = /* @__PURE__ */ dt((u) => `${u[0]},${u[1]}`, "posToStr"), N = /* @__PURE__ */ dt((u) => u.split(",").map((h) => parseInt(h)), "strToPos");
  return I.forEach((u) => {
...
function $e(I, D, C, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    g.one("layoutstop", () => {
      function t(o, s, c, f) {
        let T, d;
        const { x: v, y: L } = o, { x: b, y: A } = s;
        d = (f - L + (v - c) * (L - A) / (v - b)) / Math.sqrt(1 + Math.pow((L - A) / (v - b), 2)), T = Math.sqrt(Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(d, 2));
        const G = Math.sqrt(Math.pow(b - v, 2) + Math.pow(A - L, 2));
        T = T / G;
        let k = (b - v) * (f - L) - (A - L) * (c - v);
        switch (!0) {
          case k >= 0:
            k = 1;
            break;
      ...
      for (const o of Object.values(r.edges()))
        if (o.data?.()) {
          ...
          if (s !== f && c !== T) {
            const d = o.sourceEndpoint(), v = o.targetEndpoint(), { sourceDir: L } = be(o), [b, A] = qt(L) ? [d.x, v.y] : [v.x, d.y], { weights: G, distances: k } = t(d, v, b, A);
...
var Gr = /* @__PURE__ */ dt(async (I, D, C, P) => {
  const N = P.db, u = N.getServices(), h = N.getJunctions(), a = N.getGroups(), e = N.getEdges(), r = N.getDataStructures(), l = ke(D), i = l.append("g");
