import { D as mt, C as kt, s as _t, a as xt, c as vt, b as bt, g as rt, ar as wt, d as G, o as St, E as Lt, k as Et } from "./vendor-r1U8Lk84.js";
import { o as At } from "./ordinal-B6-f3MAq.js";
...
const Jt = (t) => (t = Et.sanitizeText(t, rt()), B[t] || (B[t] = new Zt(t), Q.push(B[t])), B[t]), te = () => Q, ee = () => q, ne = () => ({
...
${x}${Math.round(w * 100) / 100}${E}` : d;
  ...
  O.append("path").attr("d", Xt()).attr("stroke", P).attr("stroke-width", (d) => Math.max(1, d.width)), St(void 0, o, 0, b);
}, oe = {
  draw: re
}, le = (t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
