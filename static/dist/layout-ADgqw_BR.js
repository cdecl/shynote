import { G as y } from "./graph-B4hdnUXB.js";
import { a as f, i as b, f as P, v as x, r as j } from "./_baseUniq-CY_Rxnsm.js";
import { f as R, m as w, g as L, h as oe, i as $, l as C, e as ke } from "./_basePickBy-_GiuEe1z.js";
import { r as E, u as q, m as g, a as W, z as xe, s as _, p as T, c as Ee, b as S, f as Oe, d as Ne } from "./zipObject-D2eAYdyv.js";
import { V as Le, c4 as Ie, ck as D } from "./vendor-CW5mw3QE.js";
class Pe {
  constructor() {
    var n = {};
...
function Ce(e, n) {
  if (e.nodeCount() <= 1)
    return [];
  var r = je(e, n || _e), t = Te(r.graph, r.buckets, r.zeroIdx);
  return R(
    w(t, function(a) {
...
function Se(e) {
  ...
  f(n, function(t) {
    var a = e.edge(t);
    e.removeEdge(t), a.forwardName = t.name, a.reversed = !0, e.setEdge(t.w, t.v, a, q("rev"));
  });
  function r(t) {
    return function(a) {
...
function Z(e, n, r, t, a, o) {
  var i = { width: 0, height: 0, rank: o, borderType: n }, d = a[n][o - 1], u = O(e, "border", i, r);
...
function qe(e) {
  var n = e.graph().rankdir.toLowerCase();
  (n === "bt" || n === "rl") && We(e), (n === "lr" || n === "rl") && (ze(e), se(e));
}
function se(e) {
  ...
  if (o !== t + 1) {
    ...
    for (l = 0, ++t; t < o; ++l, ++t)
      d.points = [], s = {
        ...
        edgeObj: n,
        rank: t
      }, c = O(e, "edge", s, "_d"), t === u && (s.width = d.width, s.height = d.height, s.dummy = "edge-label", s.labelpos = d.labelpos), e.setEdge(r, c, { weight: d.weight }, i), l === 0 && e.graph().dummyChains.push(c), r = c;
...
function sn(e) {
  var n = O(e, "root", {}, "_root"), r = fn(e), t = g(x(r)) - 1, a = 2 * t + 1;
...
function be(e, n, r, t, a, o, i) {
  ...
  e.setParent(u, i), c.borderTop = u, e.setParent(s, i), c.borderBottom = s, f(d, function(l) {
    be(e, n, r, t, a, o, l);
    var h = e.node(l), v = h.borderTop ? h.borderTop : l, p = h.borderBottom ? h.borderBottom : l, m = h.borderTop ? t : 2 * t, N = v !== p ? 1 : a - o[i] + 1;
    e.setEdge(u, v, {
      weight: m,
      minlen: N,
      nestingEdge: !0
...
function kn(e) {
  ...
  return w(
    ...
    function(o) {
      return T(o, ["vs", "i", "barycenter", "weight"]);
    }
  );
}
function xn(e, n) {
...
function En(e, n) {
  ...
  t.sort(On(!!n)), u = te(o, a, u), f(t, function(c) {
...
function ye(e, n, r, t) {
  ...
  Nn(c, u);
  var l = En(c, t);
  if (i && (l.vs = R([i, l.vs, d]), e.predecessors(i).length)) {
...
function In(e) {
  var n = ue(e), r = ae(e, E(1, n + 1), "inEdges"), t = ae(e, E(n - 1, -1, -1), "outEdges"), a = bn(e);
  ie(e, a);
...
function Tn(e, n) {
  var r = {};
  function t(a, o) {
    var i = 0, d = 0, u = a.length, s = C(o);
    return f(o, function(c, l) {
      var h = Sn(e, c), v = h ? e.node(h).order : u;
      (h || c === s) && (f(o.slice(d, l + 1), function(p) {
        f(e.predecessors(p), function(m) {
          var N = e.node(m), H = N.order;
          (H < i || v < H) && !(N.dummy && e.node(p).dummy) && ge(r, m, p);
        });
      }), d = l + 1, i = v);
    }), o;
  }
...
function Sn(e, n) {
  if (e.node(n).dummy)
    return $(e.predecessors(n), function(r) {
...
function Bn(e, n, r, t) {
  var a = new y(), o = e.graph(), i = $n(o.nodesep, o.edgesep, t);
  return f(n, function(d) {
    var u;
    f(d, function(s) {
      var c = r[s];
...
function Gn(e) {
  var n = M(e), r = D(Tn(e, n), jn(e, n)), t = {}, a;
  f(["u", "d"], function(i) {
    a = i === "u" ? n : x(n).reverse(), f(["l", "r"], function(d) {
      d === "r" && (a = w(a, function(l) {
        return x(l).reverse();
      }));
      var u = (i === "u" ? e.predecessors : e.successors).bind(e), s = Vn(e, a, r, u), c = Fn(e, a, s.root, s.align, d === "r");
...
function Xn(e, n) {
  n("    makeSpaceForEdgeLabels", () => ar(e)), n("    removeSelfEdges", () => hr(e)), n("    acyclic", () => Se(e)), n("    nestingGraph.run", () => sn(e)), n("    rank", () => on(de(e))), n("    injectEdgeLabelProxies", () => ir(e)), n("    removeEmptyRanks", () => Ae(e)), n("    nestingGraph.cleanup", () => ln(e)), n("    normalizeRanks", () => Be(e)), n("    assignRankMinMax", () => or(e)), n("    removeEdgeLabelProxies", () => dr(e)), n("    normalize.run", () => Xe(e)), n("    parentDummyChains", () => Rn(e)), n("    addBorderSegments", () => Ge(e)), n("    order", () => In(e)), n("    insertSelfEdges", () => vr(e)), n("    adjustCoordinateSystem", () => $e(e)), n("    position", () => Wn(e)), n("    positionSelfEdges", () => pr(e)), n("    removeBorderNodes", () => lr(e)), n("    normalize.undo", () => He(e)), n("    fixupEdgeLabelCoords", () => fr(e)), n("    undoCoordinateSystem", () => qe(e)), n("    translateGraph", () => ur(e)), n("    assignNodeIntersects", () => sr(e)), n("    reversePoints", () => cr(e)), n("    acyclic.undo", () => Ve(e));
}
function Un(e, n) {
  f(e.nodes(), function(r) {
...
function tr(e) {
  ...
  return n.setGraph(
    ...
    var a = Y(e.node(t));
    n.setNode(t, ke(A(a, Qn), Zn)), n.setParent(t, e.parent(t));
...
function lr(e) {
  f(e.nodes(), function(n) {
    if (e.children(n).length) {
      var r = e.node(n), t = e.node(r.borderTop), a = e.node(r.borderBottom), o = e.node(C(r.borderLeft)), i = e.node(C(r.borderRight));
