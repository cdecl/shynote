...
var R1 = /([A-Z])/g, zt = (r) => r.replace(R1, "-$1").toLowerCase(), I1 = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
  '"': "&quot;",
  "'": "&#x27;"
}, N1 = /[&><"']/g, a0 = (r) => String(r).replace(N1, (e) => I1[e]), Be = (r) => r.type === "ordgroup" || r.type === "color" ? r.body.length === 1 ? Be(r.body[0]) : r : r.type === "font" ? Be(r.body) : r, H1 = /* @__PURE__ */ new Set(["mathord", "textord", "atom"]), D0 = (r) => H1.has(Be(r).type), O1 = (r) => {
...
var At = 0, Ce = 1, Q0 = 2, T0 = 3, oe = 4, v0 = 5, _0 = 6, s0 = 7, x0 = [new N0(At, 0, !1), new N0(Ce, 0, !0), new N0(Q0, 1, !1), new N0(T0, 1, !0), new N0(oe, 2, !1), new N0(v0, 2, !0), new N0(_0, 3, !1), new N0(s0, 3, !0)], L1 = [oe, v0, oe, v0, _0, s0, _0, s0], P1 = [v0, v0, v0, v0, s0, s0, s0, s0], G1 = [Q0, T0, oe, v0, _0, s0, _0, s0], U1 = [T0, T0, v0, v0, s0, s0, s0, s0], V1 = [Ce, Ce, T0, T0, v0, v0, s0, s0], X1 = [At, Ce, Q0, T0, Q0, T0, Q0, T0], N = {
  DISPLAY: x0[At],
  TEXT: x0[Q0],
  SCRIPT: x0[oe],
  SCRIPTSCRIPT: x0[_0]
...
var De = [];
mt.forEach((r) => r.blocks.forEach((e) => De.push(...e)));
function Dr(r) {
...
var ct = {
  ...
  var a;
  if (e.unit in ct)
    a = ct[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
  else if (e.unit === "mu")
...
var ua = (r) => r instanceof ae || r instanceof Ne || r instanceof re, w0 = {
  "AMS-Regular": {
    32: [0, 0, 0, 0, 0.25],
...
function Tt(r, e, t) {
  ...
  if (!n && r[0] in Qt && (a = Qt[r[0]].charCodeAt(0), n = w0[e][a]), !n && t === "text" && Dr(a) && (n = w0[e][77]), n)
    return {
      depth: n[0],
      height: n[1],
      italic: n[2],
...
function ha(r) {
  ...
  if (r >= 5 ? e = 0 : r >= 3 ? e = 1 : e = 2, !je[e]) {
    var t = je[e] = {
      cssEmPerMu: ye.quad[e] / 18
    };
    for (var a in ye)
      ye.hasOwnProperty(a) && (t[a] = ye[a][e]);
  }
  return je[e];
}
var ma = {
...
var s = "math", w = "text", o = "main", d = "ams", j = "accent-token", D = "bin", u0 = "close", ne = "inner", E = "mathord", e0 = "op-token", f0 = "open", me = "punct", f = "rel", C0 = "spacing", v = "textord";
i(s, o, f, "≡", "\\equiv", !0);
i(s, o, f, "≺", "\\prec", !0);
i(s, o, f, "≻", "\\succ", !0);
i(s, o, f, "∼", "\\sim", !0);
...
for (var X0 = 0; X0 < 10; X0++) {
  var H0 = X0.toString();
  R = String.fromCharCode(55349, 57294 + X0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57314 + X0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57324 + X0), i(s, o, E, H0, R), i(w, o, v, H0, R), R = String.fromCharCode(55349, 57334 + X0), i(s, o, E, H0, R), i(w, o, v, H0, R);
}
var ft = "ÐÞþ";
...
var Se = [
  ...
  return n === void 0 && (n = []), a.font === "boldsymbol" && He(e, "Main-Bold", t).metrics ? l0(e, "Main-Bold", t, a, n.concat(["mathbf"])) : e === "\\" || $[t][e].font === "main" ? l0(e, "Main-Regular", t, a, n) : l0(e, "AMS-Regular", t, a, n.concat(["amsrm"]));
  ...
  var n = e.mode, l = e.text, u = ["mord"], h = n === "math" || n === "text" && t.font, c = h ? t.font : t.fontFamily, p = "", g = "";
  ...
  if (c) {
    ...
    } else h ? (b = pt[c].fontName, y = [c]) : (b = ke(c, t.fontWeight, t.fontShape), y = [c, t.fontWeight, t.fontShape]);
    if (He(l, b, n).metrics)
  ...
  if (a === "mathord")
    return l0(l, "Math-Italic", n, t, u.concat(["mathnormal"]));
  if (a === "textord") {
    var C = $[n][l] && $[n][l].font;
    if (C === "ams") {
      var q = ke("amsrm", t.fontWeight, t.fontShape);
      return l0(l, q, n, t, u.concat("amsrm", t.fontWeight, t.fontShape));
    } else if (C === "main" || !C) {
      var I = ke("textrm", t.fontWeight, t.fontShape);
      return l0(l, I, n, t, u.concat(t.fontWeight, t.fontShape));
    } else {
      var H = ke(C, t.fontWeight, t.fontShape);
  ...
  for (var e = 0; e < r.length - 1; e++) {
    var t = r[e], a = r[e + 1];
    t instanceof d0 && a instanceof d0 && pa(t, a) && (t.text += a.text, t.height = Math.max(t.height, a.height), t.depth = Math.max(t.depth, a.depth), t.italic = a.italic, r.splice(e + 1, 1), e--);
  }
  return r;
}, Dt = function(e) {
  ...
  for (var g = [], b = n, y = n, x = n, A = 0; A < a.length; A++) {
    ...
    if (T.type === "kern")
      ...
      var C = T.elem, q = T.wrapperClasses || [], I = T.wrapperStyle || {}, H = S(q, [p, C], void 0, I);
  ...
  var [a, n, l] = Or[e], u = new L0(a), h = new B0([u], {
    width: M(n),
    height: M(l),
...
var Ie = function(e) {
...
}, xa = /* @__PURE__ */ new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]), wa = /* @__PURE__ */ new Set(["rightmost", "mrel", "mclose", "mpunct"]), Sa = {
  display: N.DISPLAY,
  text: N.TEXT,
  script: N.SCRIPT,
  ...
  if (e.length === 1) {
    var g = e[0];
    g.type === "sizing" ? p = t.havingSize(g.size) : g.type === "styling" && (p = t.havingStyle(Sa[g.style]));
  }
  var b = S([n[0] || "leftmost"], [], t), y = S([n[1] || "rightmost"], [], t), x = a === "root";
  return vt(l, (A, T) => {
    var C = T.classes[0], q = A.classes[0];
    C === "mbin" && wa.has(q) ? T.classes[0] = "mord" : q === "mbin" && xa.has(C) && (A.classes[0] = "mord");
  }, {
    node: b
  }, y, x), vt(l, (A, T) => {
    var C, q, I = bt(T), H = bt(A), F = I && H ? A.hasClass("mtight") ? (C = ya[I]) == null ? void 0 : C[H] : (q = ba[I]) == null ? void 0 : q[H] : null;
    if (F)
      return Hr(F, p);
  }, {
    node: b
  ...
  for (var u = 0; u < e.length; u++) {
    ...
    p ? a.node = h : l && h.hasClass("newline") && (a.node = S(["leftmost"])), a.insertAfter = /* @__PURE__ */ ((b) => (y) => {
      e.splice(b + 1, 0, y), u++;
    })(u);
  }
  n && e.pop();
...
var za = /* @__PURE__ */ new Set(["\\imath", "\\jmath"]), Ma = /* @__PURE__ */ new Set(["mrow", "mtable"]), g0 = function(e, t, a) {
  return $[t][e] && $[t][e].replace && e.charCodeAt(0) !== 55349 && !(Ir.hasOwnProperty(e) && a && (a.fontFamily && a.fontFamily.slice(4, 6) === "tt" || a.font && a.font.slice(4, 6) === "tt")) && (e = $[t][e].replace), new _(e);
}, Ct = function(e) {
...
var p0 = function(e, t, a) {
  ...
  for (var l = [], u, h = 0; h < e.length; h++) {
    ...
    if (c instanceof z && u instanceof z) {
      ...
      else if ((c.type === "msup" || c.type === "msub") && c.children.length >= 1 && (u.type === "mn" || _e(u))) {
        var p = c.children[0];
...
function nr(r, e, t, a, n) {
  ...
  var c = new z("semantics", [u, h]), p = new z("math", [c]);
...
class A0 {
  constructor(e) {
    this.style = e.style, this.color = e.color, this.size = e.size || A0.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = ir[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
  }
  /**
...
var Vr = function(e) {
  ...
  var n = Vr(a), l;
  if (a.output === "mathml")
    return nr(e, t, n, a.displayMode, !0);
  if (a.output === "html") {
    var u = yt(e, n);
    l = S(["katex"], [u]);
  } else {
    var h = nr(e, t, n, a.displayMode, !1), c = yt(e, n);
    l = S(["katex"], [h, c]);
  }
  return Xr(l, a);
}, Ba = function(e, t, a) {
  var n = Vr(a), l = yt(e, n), u = S(["katex"], [l]);
  return Xr(u, a);
}, Da = {
  widehat: "^",
  widecheck: "ˇ",
...
}, qa = /* @__PURE__ */ new Set(["widehat", "widecheck", "widetilde", "utilde"]), Le = function(e, t) {
  function a() {
    ...
    if (qa.has(c)) {
      ...
      var q = [], I = Ca[c], [H, F, V] = I, L = V / 1e3, P = H.length, W, X;
      if (P === 1) {
        var o0 = I[3];
        W = ["hide-tail"], X = [o0];
      } else if (P === 2)
      ...
      for (var n0 = 0; n0 < P; n0++) {
        var t0 = new L0(H[n0]), V0 = new B0([t0], {
          width: "400em",
          height: M(L),
          viewBox: "0 0 " + h + " " + V,
  ...
  if (/fbox|color|angl/.test(t)) {
    ...
    var p = [];
    /^[bx]cancel$/.test(t) && p.push(new dt({
      x1: "0",
      y1: "0",
      x2: "100%",
      y2: "100%",
      "stroke-width": "0.046em"
    })), /^x?cancel$/.test(t) && p.push(new dt({
      x1: "0",
      y1: "100%",
      x2: "100%",
      y2: "0",
...
var Yr = (r) => {
  if (r instanceof d0)
    return r;
  if (ua(r) && r.children.length === 1)
    return Yr(r.children[0]);
}, Et = (r, e) => {
  var t, a, n;
  r && r.type === "supsub" ? (a = O(r.base, "accent"), t = a.base, r.base = t, n = sa(U(r, e)), r.base = a) : (a = O(r, "accent"), t = a.base);
  ...
  if (a.isStretchy)
    ...
    var x, A;
    a.label === "\\vec" ? (x = Fr("vec", e), A = Or.vec[1]) : (x = Oe({
      mode: a.mode,
      text: a.label
    }, e, "textord"), x = la(x), x.italic = 0, A = x.width, g && (b += x.depth)), y = S(["accent-body"], [x]);
  ...
  var t = r.isStretchy ? Fe(r.label) : new z("mo", [g0(r.label, r.mode)]), a = new z("mover", [Y(r.base, e), t]);
  return a.setAttribute("accent", "true"), a;
}, Ra = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map((r) => "\\" + r).join("|"));
B({
  type: "accent",
  ...
  handler: (r, e) => {
    var t = Ie(e[0]), a = !Ra.test(r.funcName), n = !a || r.funcName === "\\widehat" || r.funcName === "\\widetilde" || r.funcName === "\\widecheck";
    return {
      type: "accent",
      mode: r.parser.mode,
      label: r.funcName,
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = U(r.base, e), a = Le(r, e), n = r.label === "\\utilde" ? 0.12 : 0, l = G({
      positionType: "top",
  ...
  mathmlBuilder: (r, e) => {
    var t = Fe(r.label), a = new z("munder", [Y(r.base, e), t]);
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var h = Le(r, e), c = -e.fontMetrics().axisHeight + 0.5 * h.height, p = -e.fontMetrics().axisHeight - 0.5 * h.height - 0.111;
    ...
    return g.children[0].children[0].children[1].classes.push("svg-align"), S(["mrel", "x-arrow"], [g], e);
  },
  mathmlBuilder(r, e) {
    var t = Fe(r.label);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = r0(r.body, e, !0), a = S([r.mclass], t, e);
...
var Ia = {
  ...
  mode: "math",
  style: "display"
}), ur = (r) => r.type === "textord" && r.text === "@", Na = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Ha(r, e, t) {
  var a = Ia[r];
  switch (a) {
    case "\\\\cdrightarrow":
  ...
  for (var a = [], n = [a], l = 0; l < e.length; l++) {
    for (var u = e[l], h = sr(), c = 0; c < u.length; c++)
      if (!ur(u[c]))
        ...
        a.push(h), c += 1;
        var p = Pe(u[c]).text, g = new Array(2);
        if (g[0] = {
          type: "ordgroup",
          mode: "math",
          body: []
...
B({
  ...
  handler(r, e) {
    for (var {
      parser: t
    } = r, a = O(e[0], "ordgroup"), n = a.body, l = "", u = 0; u < n.length; u++) {
      var h = O(n[u], "textord");
      l += h.text;
    }
    var c = parseInt(l), p;
...
B({
  ...
  handler(r) {
    ...
    var a = e.fetch();
    if (xt[a.text])
      return (t === "\\global" || t === "\\\\globallong") && (a.text = xt[a.text]), O(e.parseFunction(), "internal");
...
B({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, a = Jr(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = Fa(e);
    return Qr(e, a, n, t === "\\\\globallet"), {
      type: "internal",
      mode: e.mode
    };
  }
...
B({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, a = Jr(e.gullet.popToken()), n = e.gullet.popToken(), l = e.gullet.popToken();
    return Qr(e, a, l, t === "\\\\globalfuture"), e.gullet.pushToken(l), e.gullet.pushToken(n), {
      type: "internal",
      mode: e.mode
    };
  }
...
var se = function(e, t, a) {
  var n = $.math[e] && $.math[e].replace, l = Tt(n || e, t, a);
  if (!l)
    throw new Error("Unsupported symbol " + e + " and font size " + t + ".");
  return l;
}, Rt = function(e, t, a, n) {
  var l = a.havingBaseStyle(t), u = S(n.concat(l.sizingClasses(a)), [e], a), h = l.sizeMultiplier / a.sizeMultiplier;
  ...
  var h = l0(e, "Main-Regular", l, n), c = Rt(h, t, n, u);
  return _r(c, n, t), c;
}, Pa = function(e, t, a, n) {
  return l0(e, "Size" + t + "-Regular", a, n);
}, e1 = function(e, t, a, n, l, u) {
  var h = Pa(e, t, l, n), c = Rt(S(["delimsizing", "size" + t], [h], n), N.TEXT, n, u);
  ...
  var n = w0["Size4-Regular"][e.charCodeAt(0)] ? w0["Size4-Regular"][e.charCodeAt(0)][4] : w0["Size1-Regular"][e.charCodeAt(0)][4], l = new L0("inner", ea(e, Math.round(1e3 * t))), u = new B0([l], {
    width: M(n),
    height: M(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + M(n),
  ...
  var P = T + H + F, W = Math.max(0, Math.ceil((t - P) / (V * q))), X = P + W * V * q, o0 = n.fontMetrics().axisHeight;
  a && (o0 *= n.sizeMultiplier);
  var n0 = X / 2 - o0, t0 = [];
  if (b.length > 0) {
    var V0 = X - T - H, h0 = Math.round(X * 1e3), b0 = ta(b, Math.round(V0 * 1e3)), E0 = new L0(b, b0), $0 = (y / 1e3).toFixed(3) + "em", j0 = (h0 / 1e3).toFixed(3) + "em", We = new B0([E0], {
      width: $0,
      height: j0,
      viewBox: "0 0 " + y + " " + h0
    }), R0 = P0([], [We], n);
    R0.height = h0 / 1e3, R0.style.width = $0, R0.style.height = j0, t0.push({
      type: "elem",
      elem: R0
    });
  } else {
    if (t0.push(et(g, x, l)), t0.push(Ae), c === null) {
      var I0 = X - T - H + 2 * wt;
      t0.push(tt(p, I0, n));
    } else {
      var le = (X - T - H - F) / 2 + 2 * wt;
      t0.push(tt(p, le, n)), t0.push(Ae), t0.push(et(c, x, l)), t0.push(Ae), t0.push(tt(p, le, n));
    }
    t0.push(Ae), t0.push(et(h, x, l));
  }
  var y0 = n.havingBaseStyle(N.TEXT), de = G({
    positionType: "bottom",
    positionData: n0,
    children: t0
  });
  return Rt(S(["delimsizing", "mult"], [de], y0), N.TEXT, n, u);
}, rt = 80, at = 0.08, nt = function(e, t, a, n, l) {
  var u = _1(e, n, a), h = new L0(e, u), c = new B0([h], {
  ...
  var a = t.havingBaseSizing(), n = l1("\\surd", e * a.sizeMultiplier, i1, a), l = a.sizeMultiplier, u = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), h, c = 0, p = 0, g = 0, b;
  return n.type === "small" ? (g = 1e3 + 1e3 * u + rt, e < 1 ? l = 1 : e < 1.4 && (l = 0.7), c = (1 + u + at) / l, p = (1 + u) / l, h = nt("sqrtMain", c, g, u, t), h.style.minWidth = "0.853em", b = 0.833 / l) : n.type === "large" ? (g = (1e3 + rt) * ue[n.size], p = (ue[n.size] + u) / l, c = (ue[n.size] + u + at) / l, h = nt("sqrtSize" + n.size, c, g, u, t), h.style.minWidth = "1.02em", b = 1 / l) : (c = e + u + at, p = e + u, g = Math.floor(1e3 * e + u) + rt, h = nt("sqrtTall", c, g, u, t), h.style.minWidth = "0.742em", b = 1.056), h.height = p, h.style.height = M(c), {
    span: h,
    advanceWidth: b,
...
}, r1 = /* @__PURE__ */ new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"]), Xa = /* @__PURE__ */ new Set(["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"]), a1 = /* @__PURE__ */ new Set(["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]), ue = [0, 1.2, 1.8, 2.4, 3], n1 = function(e, t, a, n, l) {
  if (e === "<" || e === "\\lt" || e === "⟨" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"), r1.has(e) || a1.has(e))
    return e1(e, t, !1, a, n, l);
  if (Xa.has(e))
    return t1(e, ue[t], !1, a, n, l);
  ...
  for (var l = Math.min(2, 3 - n.style.size), u = l; u < a.length; u++) {
    ...
    if (h.type === "stack")
      break;
    var c = se(e, $a(h), "math"), p = c.height + c.depth;
    if (h.type === "small") {
  ...
  var c = l1(e, t, h, n);
  return c.type === "small" ? La(e, c.style, a, n, l, u) : c.type === "large" ? e1(e, c.size, a, n, l, u) : t1(e, t, a, n, l, u);
}, it = function(e, t, a, n, l, u) {
  var h = n.fontMetrics().axisHeight * n.sizeMultiplier, c = 901, p = 5 / n.fontMetrics().ptPerEm, g = Math.max(t - h, a + h), b = Math.max(
...
}, ja = /* @__PURE__ */ new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."]);
function Ve(r, e) {
  var t = Ge(r);
  if (t && ja.has(t.text))
    return t;
...
B({
  ...
  htmlBuilder: (r, e) => r.delim === "." ? S([r.mclass]) : n1(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: (r) => {
    var e = [];
...
B({
  ...
  htmlBuilder: (r, e) => {
    ...
    var h;
    if (r.left === "." ? h = he(e, ["mopen"]) : h = it(r.left, a, n, e, r.mode, ["mopen"]), t.unshift(h), l)
...
var It = (r, e) => {
  ...
  if (a === "sout")
    l = S(["stretchy", "sout"]), l.height = e.fontMetrics().defaultRuleThickness / n, u = -0.5 * e.fontMetrics().xHeight;
  else if (a === "phase") {
    var c = K({
      number: 0.6,
      unit: "pt"
    ...
    var y = Math.floor(1e3 * b * n), x = J1(y), A = new B0([new L0("phase", x)], {
      width: "400em",
      height: M(y / 1e3),
  ...
  return /cancel/.test(a) && (I.height = t.height, I.depth = t.depth), /cancel/.test(a) && !h ? S(["mord", "cancel-lap"], [I], e) : S(["mord"], [I], e);
}, Nt = (r, e) => {
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a,
      funcName: n
    } = r, l = O(e[0], "color-token").color, u = e[1];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a,
      funcName: n
    } = r, l = O(e[0], "color-token").color, u = O(e[1], "color-token").color, h = e[2];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
}, Za = /* @__PURE__ */ new Set(["gather", "gather*"]);
function Ht(r) {
  if (!r.includes("ed"))
    return !r.includes("*");
}
function U0(r, e, t) {
  ...
  r.gullet.beginGroup();
  var A = [], T = [A], C = [], q = [], I = c != null ? [] : void 0;
  function H() {
    c && r.gullet.macros.set("\\@eqnsw", "1", !0);
  }
  function F() {
    I && (r.gullet.macros.get("\\df@tag") ? (I.push(r.subparse([new c0("\\df@tag")])), r.gullet.macros.set("\\df@tag", void 0, !0)) : I.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (H(), q.push(mr(r)); ; ) {
    ...
    if (P === "&") {
      ...
      r.consume();
      var W = void 0;
      r.gullet.future().text !== " " && (W = r.parseSizeGroup(!0)), C.push(W ? W.value : null), F(), q.push(mr(r)), A = [], T.push(A), H();
    } else
...
var k0 = function(e, t) {
  var a, n, l = e.body.length, u = e.hLinesBeforeRow, h = 0, c = new Array(l), p = [], g = Math.max(
  ...
  for (F(u[0]), a = 0; a < e.body.length; ++a) {
    ...
    o0 && (n0 = K(o0, t), n0 > 0 && (n0 += I, P < n0 && (P = n0), n0 = 0)), e.addJot && (P += T), W.height = L, W.depth = P, H += L, W.pos = H, H += P + n0, c[a] = W, F(u[a + 1]);
  }
  var t0 = H / 2 + t.fontMetrics().axisHeight, V0 = e.cols || [], h0 = [], b0, E0, $0 = [];
  if (e.tags && e.tags.some((ge) => ge))
    for (a = 0; a < l; ++a) {
      var j0 = c[a], We = j0.pos - t0, R0 = e.tags[a], I0 = void 0;
      R0 === !0 ? I0 = S(["eqn-num"], [], t) : R0 === !1 ? I0 = S([], [], t) : I0 = S([], r0(R0, t, !0), t), I0.depth = j0.depth, I0.height = j0.height, $0.push({
        type: "elem",
        elem: I0,
        shift: We
      });
  ...
  for (
    ...
    for (var le, y0 = V0[E0], de = !0; ((Ut = y0) == null ? void 0 : Ut.type) === "separator"; ) {
      var Ut;
      if (de || (b0 = S(["arraycolsep"], []), b0.style.width = M(t.fontMetrics().doubleRuleSep), h0.push(b0)), y0.separator === "|" || y0.separator === ":") {
        var M1 = y0.separator === "|" ? "solid" : "dashed", Z0 = S(["vertical-separator"], [], t);
        Z0.style.height = M(H), Z0.style.borderRightWidth = M(g), Z0.style.borderRightStyle = M1, Z0.style.margin = "0 " + M(-g / 2);
        var Vt = H - t0;
    ...
    if (!(n >= h)) {
      ...
      if (n > 0 || e.hskipBeforeAndAfter) {
        var Xt, Yt;
        K0 = (Xt = (Yt = y0) == null ? void 0 : Yt.pregap) != null ? Xt : y, K0 !== 0 && (b0 = S(["arraycolsep"], []), b0.style.width = M(K0), h0.push(b0));
      }
      var Wt = [];
      for (a = 0; a < l; ++a) {
        var fe = c[a], pe = fe[n];
        if (pe) {
          var A1 = fe.pos - t0;
          pe.depth = fe.depth, pe.height = fe.height, Wt.push({
            type: "elem",
            elem: pe,
            shift: A1
          });
      ...
      if (h0.push(B1), n < h - 1 || e.hskipBeforeAndAfter) {
        var $t, jt;
        K0 = ($t = (jt = y0) == null ? void 0 : jt.postgap) != null ? $t : y, K0 !== 0 && (b0 = S(["arraycolsep"], []), b0.style.width = M(K0), h0.push(b0));
      }
    }
  }
  var ve = S(["mtable"], h0);
  if (p.length > 0) {
    for (var D1 = ee("hline", t, g), C1 = ee("hdashline", t, g), $e = [{
      type: "elem",
      elem: ve,
      shift: 0
    }]; p.length > 0; ) {
      var Zt = p.pop(), Kt = Zt.pos - t0;
      Zt.isDashed ? $e.push({
        type: "elem",
        elem: C1,
        shift: Kt
  ...
  if (e.cols && e.cols.length > 0) {
    var A = e.cols, T = "", C = !1, q = 0, I = A.length;
    A[0].type === "separator" && (y += "top ", q = 1), A[A.length - 1].type === "separator" && (y += "bottom ", I -= 1);
    for (var H = q; H < I; H++) {
      var F = A[H];
      F.type === "align" ? (x += Ka[F.align], C && (T += "none "), C = !0) : F.type === "separator" && C && (T += F.separator === "|" ? "solid " : "dashed ", C = !1);
    }
...
S0({
  ...
  handler(r, e) {
    var t = Ge(e[0]), a = t ? [e[0]] : O(e[0], "ordgroup").body, n = a.map(function(u) {
      var h = Pe(u), c = h.text;
      if ("lcr".includes(c))
        return {
          type: "align",
...
S0({
  ...
  handler(r) {
    ...
    var l = U0(r.parser, a, Ot(r.envName)), u = Math.max(0, ...l.body.map((h) => h.length));
...
S0({
  ...
  handler(r, e) {
    var t = Ge(e[0]), a = t ? [e[0]] : O(e[0], "ordgroup").body, n = a.map(function(h) {
      var c = Pe(h), p = c.text;
      if ("lc".includes(p))
        return {
          type: "align",
...
var Ja = (r, e) => {
  ...
  var V, L;
  return r.leftDelim == null ? V = he(e, ["mopen"]) : V = St(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? L = S([]) : r.rightDelim == null ? L = he(e, ["mclose"]) : L = St(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ["mclose"]), S(["mord"].concat(l.sizingClasses(e)), [V, S(["mfrac"], [C]), L], e);
}, Qa = (r, e) => {
...
B({
  ...
  handler: (r, e) => {
    ...
    return p || a.startsWith("\\d") ? g = "display" : a.startsWith("\\t") && (g = "text"), c1({
      type: "genfrac",
      mode: t.mode,
      numer: n,
      denom: l,
...
var fr = ["display", "text", "script", "scriptscript"], pr = function(e) {
  var t = null;
...
B({
  ...
  handler(r, e) {
    var {
      parser: t
    } = r, a = e[4], n = e[5], l = Ie(e[0]), u = l.type === "atom" && l.family === "open" ? pr(l.text) : null, h = Ie(e[1]), c = h.type === "atom" && h.family === "close" ? pr(h.text) : null, p = O(e[2], "size"), g, b = null;
    ...
    if (x.type === "ordgroup") {
      ...
      x = O(x, "textord"), y = fr[Number(x.text)];
    return c1({
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
var d1 = (r, e) => {
  ...
  var l = U(n.base, e.havingBaseStyle(N.DISPLAY)), u = Le(n, e), h;
  if (n.isOver ? (h = G({
    positionType: "firstBaseline",
    children: [{
      type: "elem",
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t;
    r.alignment === "clap" ? (t = S([], [U(r.body, e)]), t = S(["inner"], [t], e)) : t = S(["inner"], [U(r.body, e)]);
    var a = S(["fix"], []), n = S([r.alignment], [t, a], e), l = S(["strut"]);
    return l.style.height = M(n.height + n.depth), n.depth && (l.style.verticalAlign = M(-n.depth)), n.children.unshift(l), n = S(["thinbox"], [n], e), S(["mord", "vbox"], [n], e);
  },
  mathmlBuilder: (r, e) => {
...
var f1 = (r, e, t, a, n, l, u) => {
...
}, p1 = /* @__PURE__ */ new Set(["\\smallint"]), ie = (r, e) => {
  var t, a, n = !1, l;
  ...
  if (l.symbol) {
    ...
    if ((l.name === "\\oiint" || l.name === "\\oiiint") && (g = l.name.slice(1), l.name = g === "oiint" ? "\\iint" : "\\iiint"), c = l0(l.name, p, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]), g.length > 0) {
      var b = c.italic, y = Fr(g + "Size" + (h ? "2" : "1"), e);
      c = G({
        positionType: "individualShift",
        children: [{
          type: "elem",
    ...
    var x = r0(l.body, e, !0);
    x.length === 1 && x[0] instanceof d0 ? (c = x[0], c.classes[0] = "mop") : c = S(["mop"], x, e);
  } else {
    for (var A = [], T = 1; T < l.name.length; T++)
      A.push(Bt(l.name[T], l.mode, e));
    c = S(["mop"], A, e);
  }
  var C = 0, q = 0;
  return (c instanceof d0 || l.name === "\\oiint" || l.name === "\\oiiint") && !l.suppressBaseShift && (C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight, q = c.italic || 0), n ? f1(c, t, a, e, u, q, C) : (C && (c.style.position = "relative", c.style.top = M(C)), c);
}, ce = (r, e) => {
  var t;
  if (r.symbol)
    t = new z("mo", [g0(r.name, r.mode)]), p1.has(r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
...
var v1 = (r, e) => {
  var t, a, n = !1, l;
  r.type === "supsub" ? (t = r.sup, a = r.sub, l = O(r.base, "operatorname"), n = !0) : l = O(r, "operatorname");
  var u;
  if (l.body.length > 0) {
    ...
    }), c = r0(h, e.withFont("mathrm"), !0), p = 0; p < c.length; p++) {
      var g = c[p];
  ...
  for (var t = p0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
    var l = t[n];
    if (!(l instanceof Ur)) if (l instanceof z)
      switch (l.type) {
        case "mi":
        case "mn":
        case "mspace":
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = S(["inner"], [U(r.body, e.withPhantom())]), a = S(["fix"], []);
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a
    } = r, n = t[0], l = O(e[0], "size"), u = O(e[1], "size");
    return {
      type: "rule",
      mode: a.mode,
  ...
  htmlBuilder(r, e) {
    var t = S(["mord", "rule"], [], e), a = K(r.width, e), n = K(r.height, e), l = r.shift ? K(r.shift, e) : 0;
...
B({
  ...
  handler: (r, e, t) => {
    var {
      parser: a
    } = r, n = !1, l = !1, u = t[0] && O(t[0], "ordgroup");
    if (u)
...
B({
  ...
  htmlBuilder(r, e) {
    var t = br[r.style], a = e.havingStyle(t).withFont("");
    return g1(r.body, a, e);
  },
  mathmlBuilder(r, e) {
    var t = br[r.style], a = e.havingStyle(t), n = p0(r.body, a), l = new z("mstyle", n), u = {
      display: ["0", "true"],
      text: ["0", "false"],
      script: ["1", "false"],
...
W0({
  ...
  htmlBuilder(r, e) {
    ...
    var {
      ...
      sup: n,
      sub: l
    } = r, u = U(a, e), h, c, p = e.fontMetrics(), g = 0, b = 0, y = a && D0(a);
    if (n) {
...
W0({
  ...
  mathmlBuilder(r, e) {
    var t = new z("mi", [g0(r.text, r.mode, e)]), a = qt(r, e) || "italic";
...
W0({
  ...
  mathmlBuilder(r, e) {
    var t = g0(r.text, r.mode, e), a = qt(r, e) || "normal", n;
    return r.mode === "text" ? n = new z("mtext", [t]) : /[0-9]/.test(r.text) ? n = new z("mn", [t]) : r.text === "\\prime" ? n = new z("mo", [t]) : n = new z("mi", [t]), a !== b1[n.type] && n.setAttribute("mathvariant", a), n;
  }
});
var st = {
  "\\nobreak": "nobreak",
  ...
  htmlBuilder(r, e) {
    if (ut.hasOwnProperty(r.text)) {
      ...
      if (r.mode === "text") {
        ...
        return S(["mspace", t], [Bt(r.text, r.mode, e)], e);
    } else {
      if (st.hasOwnProperty(r.text))
        return S(["mspace", st[r.text]], [], e);
...
W0({
  type: "tag",
  mathmlBuilder(r, e) {
    var t = new z("mtable", [new z("mtr", [yr(), new z("mtd", [G0(r.body, e)]), yr(), new z("mtd", [G0(r.tag, e)])])]);
...
var xr = {
  ...
  if (t) {
    if (xr[t])
      return e.withTextFontFamily(xr[t]);
    if (wr[t])
      return e.withTextFontWeight(wr[t]);
    if (t === "\\emph")
...
B({
  ...
  mathmlBuilder(r, e) {
    var t = new _(kr(r)), a = new z("mtext", [t]);
    return a.setAttribute("mathvariant", "monospace"), a;
  }
});
var kr = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), O0 = Lr, y1 = `[ \r
	]`, l4 = "\\\\[a-zA-Z@]+", s4 = "\\\\[^\uD800-\uDFFF]", u4 = "(" + l4 + ")" + y1 + "*", o4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, kt = "[̀-ͯ]", h4 = new RegExp(kt + "+$"), m4 = "(" + y1 + "+)|" + // whitespace
(o4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(kt + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
class zr {
  ...
  constructor(e, t) {
    this.input = e, this.settings = t, this.tokenRegex = new RegExp(m4, "g"), this.catcodes = {
      "%": 14,
      // comment character
      "~": 13
      // active character
...
m("\\dots", function(r) {
  ...
  return t in Ar ? e = Ar[t] : (t.slice(0, 4) === "\\not" || t in $.math && f4.has($.math[t].group)) && (e = "\\dotsb"), e;
});
var Lt = {
...
m("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + x1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
m("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + x1 + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
...
class p4 {
  constructor(e, t, a) {
    this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new c4(d4, t.macros), this.mode = a, this.stack = [];
  }
  /**
   ...
   */
  isDefined(e) {
    return this.macros.has(e) || O0.hasOwnProperty(e) || $.math.hasOwnProperty(e) || $.text.hasOwnProperty(e) || S1.hasOwnProperty(e);
  }
  /**
...
var Tr = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Te = Object.freeze({
  "₊": "+",
  "₋": "-",
  "₌": "=",
  "₍": "(",
...
class Ye {
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (Ye.endOfExpression.has(n.text) || t && n.text === t || e && O0[n.text] && O0[n.text].infix)
        break;
  ...
  parseSymbol() {
    ...
    Br.hasOwnProperty(t[0]) && !$[this.mode][t[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = Br[t[0]] + t.slice(1));
    var l = h4.exec(t);
    ...
    if ($[this.mode][t]) {
      ...
      var h = $[this.mode][t].group, c = m0.range(e), p;
      ...
      this.settings.strict && (Dr(t.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '"' + (" (" + t.charCodeAt(0) + ")"), e)), u = {
        type: "textord",
        mode: "text",
        loc: m0.range(e),
        text: t
