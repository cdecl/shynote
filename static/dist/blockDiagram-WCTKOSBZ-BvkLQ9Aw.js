import { g as ce } from "./chunk-FMBD7UC4-CC3FZtNG.js";
import { aD as g, b7 as at, d as T, aK as oe, aJ as S, b2 as he, U as ge, aI as R, bq as de, D as ue, H as pe, bh as fe, br as F, bs as St, bt as $, bu as xe, aW as tt, aQ as ye, bv as be, aN as Nt, bw as It, bx as we } from "./vendor-Dsy1-eqI.js";
import { c as me } from "./clone-vl_Qg_aI.js";
import { G as Le } from "./graph-BNeFSKWr.js";
import { c as Se } from "./channel-CH1utLE3.js";
var yt = (function() {
  var e = /* @__PURE__ */ g(function(D, w, d, y) {
    ...
    performAction: /* @__PURE__ */ g(function(w, d, y, k, E, h, P) {
      var p = h.length - 1;
      switch (E) {
        case 4:
    ...
    parse: /* @__PURE__ */ g(function(w) {
      var d = this, y = [0], k = [], E = [null], h = [], P = this.table, p = "", O = 0, Z = 0, V = 2, st = 1, ie = h.slice.call(arguments, 1), z = Object.create(this.lexer), q = { yy: {} };
      ...
      g(Tt, "lex");
      for (var W, J, K, pt, Q = {}, it, G, Bt, nt; ; ) {
        if (J = y[y.length - 1], this.defaultActions[J] ? K = this.defaultActions[J] : ((W === null || typeof W > "u") && (W = Tt()), K = P[J] && P[J][W]), typeof K > "u" || !K.length || !K[0]) {
          var ft = "";
          nt = [];
          for (it in P[J])
...
` + z.showPosition() + `
Expecting ` + nt.join(", ") + ", got '" + (this.terminals_[W] || W) + "'" : ft = "Parse error on line " + (O + 1) + ": Unexpected " + (W == st ? "end of input" : "'" + (this.terminals_[W] || W) + "'"), this.parseError(ft, {
            text: z.match,
        ...
        switch (K[0]) {
          case 1:
            y.push(W), E.push(z.yytext), h.push(z.yylloc), y.push(K[1]), W = null, Z = z.yyleng, p = z.yytext, O = z.yylineno, ut = z.yylloc;
            break;
          case 2:
            if (G = this.productions_[K[1]][1], Q.$ = E[E.length - G], Q._$ = {
              ...
              return pt;
            G && (y = y.slice(0, -1 * G * 2), E = E.slice(0, -1 * G), h = h.slice(0, -1 * G)), y.push(this.productions_[K[1]][0]), E.push(Q.$), h.push(Q._$), Bt = P[y[y.length - 2]][y[y.length - 1]], y.push(Bt);
            break;
          case 3:
            return !0;
        }
...
var Rt = 0, Ie = /* @__PURE__ */ g(() => (Rt++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Rt), "generateId"), Ce = /* @__PURE__ */ g((e) => {
  ...
  X.set(e.id, e);
}, "setBlock"), We = /* @__PURE__ */ g(() => S, "getLogger"), Pe = /* @__PURE__ */ g(function() {
  return ct;
}, "getClasses"), Ye = {
...
var zr = /* @__PURE__ */ g(async (e, t) => {
  ...
  if (t.link) {
    let s;
    R().securityLevel === "sandbox" ? s = "_top" : t.linkTarget && (s = t.linkTarget || "_blank"), i = e.insert("svg:a").attr("xlink:href", t.link).attr("target", s), l = await Pt[t.shape](i, t, a);
  } else
    l = await Pt[t.shape](e, t, a), i = l;
